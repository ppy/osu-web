...
function bbcode($text, $uid, $withGallery = false, $withImageDimensions = true)
{
    return (new App\Libraries\BBCodeFromDB($text, $uid, $withGallery))->toHTML(false, $withImageDimensions);
}
