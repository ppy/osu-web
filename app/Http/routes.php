...
Route::get('/ranking/scores/overall', ['as' => 'ranking.scores.overall', 'uses' => 'RankingController@scoresOverall']);
Route::get('/ranking/scores/country', ['as' => 'ranking.scores.country', 'uses' => 'RankingController@scoresCountry']);
