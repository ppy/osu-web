...
class BBCodeFromDB
{
    ...
    {
        $text = str_replace("[youtube:{$this->uid}]", "<div class='bbcode__video'><iframe src='https://www.youtube.com/embed/", $text);
        $text = str_replace("[/youtube:{$this->uid}]", "?rel=0' frameborder='0' allowfullscreen></iframe></div>", $text);
