...
class BeatmapSet extends Model {
	...
	public function rank(User $user = null) { $this->setRank(static::RANKED, $user); }
	public function pending(User $user = null) { $this->setRank(static::PENDING, $user); }
	public function wip(User $user = null) { $this->setRank(static::WIP, $user); }
	public function approve(User $user = null) { $this->setRank(static::APPROVED, $user); }
	public function qualify(User $user = null) { $this->setRank(static::QUALIFIED, $user); }
	public function graveyard(User $user = null) { $this->setRank(static::GRAVEYARD, $user); }
	...
	|
	*/
	public function scopeGraveyard($query) { return $query->where("approved", "=", static::GRAVEYARD); }
	public function scopeWip($query) { return $query->where("approved", "=", static::WIP); }
	public function scopeUnranked($query) { return $query->where("approved", "=", static::PENDING); }
	public function scopeRanked($query) { return $query->where("approved", "=", static::RANKED); }
	public function scopeApproved($query) { return $query->where("approved", "=", static::APPROVED); }
	public function scopeQualified($query) { return $query->where("approved", "=", static::QUALIFIED); }

	// one-time checks
	public function isGraveyard() { return $this->approved == static::GRAVEYARD; }
	public function isWIP() { return $this->approved == static::WIP; }
	public function isPending() { return $this->approved == static::PENDING; }
	public function isRanked() { return $this->approved == static::RANKED; }
	public function isApproved() { return $this->approved == static::APPROVED; }
	public function isQualified() { return $this->approved == static::QUALIFIED; }
