...
class CreateBanchostatsTable extends Migration
{
     ...
     */
    /*
    CREATE TABLE osu_banchostats
(
    banchostats_id INT(11) UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,
    users_irc SMALLINT(6) NOT NULL,
    users_osu SMALLINT(6) NOT NULL,
    multiplayer_games SMALLINT(6) NOT NULL,
