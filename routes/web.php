...
// old url
route_redirect('beatmapsets/{beatmapset}/discussion', 'beatmapsets.discussions');
Route::get('beatmapsets/{beatmapset}/discussions', 'BeatmapsetsController@discussions')->name('beatmapsets.discussions');
