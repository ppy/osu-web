...
return [
    ...
    */
    ...
    'connections' => [
        'mysql' => array_merge($mysqlBase, [
            'database' => env('DB_DATABASE', 'osu'),
        ]),

        // slave copy of 'mysql'
        'mysql-readonly' => array_merge($mysqlBase, [
            'host' => env('DB_HOST_READONLY', env('DB_HOST', 'localhost')),
            'database' => env('DB_DATABASE_READONLY', env('DB_DATABASE', 'osu')),
        ]),

        'mysql-mp' => array_merge($mysqlBase, [
            'database' => env('DB_DATABASE_MP', 'osu'),
        ]),

        'mysql-chat' => array_merge($mysqlBase, [
            'database' => env('DB_DATABASE_CHAT', 'osu_chat'),
        ]),

        'mysql-store' => array_merge($mysqlBase, [
            'database' => env('DB_DATABASE_STORE', 'osu_store'),
        ]),

        'mysql-updates' => array_merge($mysqlBase, [
