...
import { hasAvailabilityInfo, nominationsCount } from 'utils/beatmapset-helper';
...
export class NewDiscussion extends React.Component<Props> {
  ...
  private get canPost() {
    ...
    if (hasAvailabilityInfo(this.props.beatmapset)) return false;
  ...
  private get textareaPlaceholder() {
    ...
    } else if (this.props.beatmapset.discussion_locked || hasAvailabilityInfo(this.props.beatmapset)) {
