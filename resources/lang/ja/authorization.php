...
return [
    'beatmap_discussion' => [
        ...
        'resolve' => [
            'not_owner' => '決議できるのはスレッド作成者と譜面作者のみです。',
        ],
        ...
        'vote' => [
            'limit_exceeded' => 'さらに投票するには少し間を置いてください。',
            'owner' => "自分のディスカッションには投票できません。",
            'wrong_beatmapset_state' => '保留中の譜面のディスカッションにのみ投票できます。',
        ],
    ],
    ...
    'chat' => [
        ...
        'friends_only' => 'ユーザーは友達リストにいない人からのメッセージをブロックしています。',
