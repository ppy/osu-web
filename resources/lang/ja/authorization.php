...
return [
    ...
    'beatmapset' => [
        ...
        'rate' => [
            'owner' => '自分が制作に関わっているビートマップセットを評価することはできません。',
            'status' => 'このステータスのビートマップセットには評価をつけることができません。',
        ],
    ],
    ...
    'chat' => [
        ...
        'no_announce' => 'アナウンスを投稿する権限がありません。',
        'receive_friends_only' => 'フレンドリストの人からのみメッセージを受信するようにしているため、ユーザーは返信できない場合があります。',
    ...
    'team' => [
        ...
        'store' => [
            'require_supporter_tag' => 'チームを作成するには osu!supporter が必要です。',
        ],
    ],
