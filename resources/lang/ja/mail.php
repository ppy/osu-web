...
return [
    ...
    'donation_thanks' => [
        ...
        'keep_free' => 'あなたのような人々のおかげで、osu!は広告や支払いなしでゲームとコミュニティを稼働し続けることができます。',
        'keep_running' => 'サポートを続けるにはosu!を:minutes 実行し続ける必要があります！それは多くないように見えるかもしれませんが、全てを合計します:)',
        'subject' => 'ありがとうございます! osu!はあなたのことが大好きです♥',
        'translation' => '情報提供のためにユーザーが提供する翻訳は次の通りです:',
