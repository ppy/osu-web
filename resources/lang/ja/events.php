...
return [
    ...
    'user_support_first' => '<strong>:user</strong>はサポーターになりました - 感謝です！',
    'user_support_gift' => '<strong>:user</strong>はサポーターギフトを貰いました',
    'username_change' => '<strong>:previousUsername</strong>は<strong><em>:user</strong></em>に名前を変更しました！',
];
