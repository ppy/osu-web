...
return [
    'edit' => [
        ...
        'avatar' => [
            'title' => 'Аватар',
            'reset' => 'нулиране',
            'rules' => 'Моля, уверете се че вашият аватар се придържа към :link.<br/>Това означава, че задължително трябва да бъде <strong>подходящ за всички възрасти</strong>. т.е. няма голота, ругатни или внушаващо съдържание.',
