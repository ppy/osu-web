...
return [
    ...
    'notifications' => [
        'beatmapset_discussion_qualified_problem' => 'покажи известие за нов проблем с квалифициран бийтмап от следния режим на игра:',
    ...
    'privacy' => [
        'friends_only' => 'блокиране на лични съобщения от хора с които не съм приятел',
