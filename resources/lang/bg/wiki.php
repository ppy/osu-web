...
return [
    'show' => [
        ...
        'outdated' => [
            '_' => 'Тази страница съдържа стар превод на оригиналното съдържание. Моля проверете :default за най-точната информация (и помислете за актуализиране на превода, ако искате да помогнете)!',
