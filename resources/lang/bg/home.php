...
да започнете!",
        ...
        'help' => [
            '_' => 'при проблем със стартиране на играта или регистриране на акаунт, посетете :help_forum_link или :support_button.',
        ...
        'steps' => [
            'register' => [
                'title' => 'създай акаунт',
                'description' => 'следвай указанията при стартиране на играта, за вход или създаване на нов акаунт',
            ],
            'download' => [
