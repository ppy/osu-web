...
return [
    ...
    'beatmap_discussion' => [
        ...
        'resolve' => [
            'not_owner' => 'Само автор и притежател на бийтмап може да приключи дискусия.',
        ],

        'store' => [
            'mapper_note_wrong_user' => 'Само собственик на биийтмап или номинатор/член на NAT група може да публикува бележки.',
        ],

        'vote' => [
            'bot' => "Не може да се гласува в дискусия, създадена от бот",
            'limit_exceeded' => 'Трябва да се изчака, преди отново да гласувате',
            'owner' => "Не може да се гласува в собствената дискусия.",
            'wrong_beatmapset_state' => 'Може да се гласува само в дискусии за бийтмапове, чакащи одобрение.',
        ],
    ],
    ...
    'chat' => [
        ...
        'restricted' => 'Не може да се изпращат съобщения докато сте заглушен, ограничен или баннат.',
        'silenced' => 'Не може да се изпращат съобщения докато сте заглушен, ограничен или баннат.',
    ],
        ...
        'topic' => [
            'reply' => [
                ...
                'user' => [
                    ...
                    'restricted' => "Не може да се отговори, докато сте ограничени.",
                    'silenced' => "Не може да се отговори, докато сте заглушени.",
                ],
            ],
            ...
            'vote' => [
                ...
                'user' => [
                    ...
                    'restricted' => "Не може да се гласува, докато сте ограничени.",
                    'silenced' => "Не може да се гласува, докато сте заглушени.",
                ],
            ],
