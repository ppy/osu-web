...
return [
    ...
    'beatmap_tag' => [
        'store' => [
            'no_score' => 'Трябва да поставиш резултат на бийтмап, за да добавяш етикет.',
        ],
    ],
    ...
    'chat' => [
        ...
        'no_announce' => 'Нямате право да публикувате изявления.',
    ...
    'contest' => [
        'judging_not_active' => 'Журито за този конкурс не е активно.',
    ...
    'forum' => [
        ...
        'post' => [
            ...
            'edit' => [
                ...
                'no_forum_access' => 'Нямате нужния достъп за този форум.',
                'no_permission' => 'Нямате разрешение за редактиране.',
                'not_owner' => 'Само създател на публикацията може да я редактира.',
    ...
    'room' => [
        'destroy' => [
            'not_owner' => 'Само създателят на стаята може да я закрива.',
        ],
    ],

    'score' => [
        'pin' => [
            'disabled_type' => "Не може да се закачи този вид резултат",
            'failed' => "Не може да закачите непреминат резултат.",
