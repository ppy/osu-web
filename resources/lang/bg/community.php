...
return [
    'support' => [
        ...
        'dev_quote' => 'osu! е изцяло безплатна, но за съжаление поддръжката й изобщо не е.
        ...
        осигуряването на награди за турнири, отговарянето на запитвания и цялостното задоволяване на хората, osu! изсмуква доста голямо количесто пари и време.
        О, и да не забравяме факта, че ние не използваме реклами в продуктите си, и не партнираме с компании, които биха могли да нарушат Вашето удоволствие към играта.
            <br/><br/>В края на деня до голяма степен osu! се разработва и поддържа от мен, когото вие може би познавате като "peppy".
Наложи се да напусна работата си, за да не изоставам с разработката на osu! и често ми се налага да отделям повече време на отделни части на играта, за да поддържам високия й стандарт.
            Бих искал да отправя личната си благодарност към тези, които решиха да подкрепят osu! досега, също както и на тези, които продължават да подпомагат финансово тази изумителна игра и нейното сплотено общество :).',
