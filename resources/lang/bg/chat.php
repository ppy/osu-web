...
return [
    ...
    'cannot_send' => [
        ...
        'reasons' => [
            'blocked' => 'Блокирани сте от получателя',
            'channel_moderated' => 'Каналът е ограничен',
            'friends_only' => 'Получателят приема само съобщения от хора, които са част от списъка му с приятели',
            'not_enough_plays' => 'Не сте изиграли достатъчно игри',
            'not_verified' => 'Сесията не е потвърдена',
            'restricted' => 'В момента сте ограничени',
            'silenced' => 'В момента сте заглушени',
            'target_restricted' => 'Получателят в момента е ограничен',
        ],
    ],
    'input' => [
