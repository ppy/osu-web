...
return [
    ...
    'limitation_notice' => 'Бележка: Само хората, които използват <a href=":lazer_link">osu!lazer</a> или новият сайт ще получат лични съобщения чрез тази система.<br/>Ако не сте сигурни, вместо това можете да изпратите съобщение чрез <a href=":oldpm_link">старата страница за лични съобщения</a>.',
    'talking_in' => 'говорите в :channel',
    'talking_with' => 'говорите с :name',
    'title_compact' => 'чат',
    'title' => 'Чат',
    'cannot_send' => [
        ...
        'reasons' => [
            ...
            'restricted' => 'Вмомента сте с ограничен статут',
            'target_restricted' => 'Получателят е вмомента с ограничен статут',
        ],
    ],
    'input' => [
    ...
    'no-conversations' => [
        ...
        'pm_limitations' => 'Само хората, които използват <a href=":link">osu!lazer</a> или новият сайт ще получат лични съобщения.',
