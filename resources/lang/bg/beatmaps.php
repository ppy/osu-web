...
return [
    ...
    'discussions' => [
        ...
        'message_placeholder_silenced' => "Не може да се публикуват дискусии, докато сте заглушени.",
        'message_type_select' => 'Избери тип на коментар',
        ...
        'message_type' => [
            'disqualify' => 'Дисквалифицирай',
            'hype' => 'Надъхване!',
            'mapper_note' => 'Бележка',
            'nomination_reset' => 'Анулирай Номинация',
            'praise' => 'Похвала',
            'problem' => 'Проблем',
            'review' => 'Ревю',
        ...
        'new' => [
            ...
            'timestamp_missing' => 'ctrl-c в редактор и вмъкнете вашето съобщение, за да добавите времеви етикет!',
            'title' => 'Нова Дискусия',
            'unpin' => 'Откачи',
        ],
        ...
        'status-messages' => [
            ...
            'wip' => 'Забележка: Този бийтмап е означен от създателя като: работи се по него...',
        ],
    ...
    'nominations' => [
        ...
        'love_confirm' => 'Обичате този Бийтмап?',
        'nominate' => 'Номинирай',
        ...
        'reset_at' => [
            'nomination_reset' => 'Номинационният процес е занулен :time_ago от :user заради нов проблем :discussion (:message).',
            'disqualify' => 'Дисквалифициран :time_ago от :user заради нов проблем :discussion (:message).',
        ],

        'reset_confirm' => [
            'nomination_reset' => 'Сигурни ли сте? Публикуването на нов проблем ще занули номинационния процес.',
