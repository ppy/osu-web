...
return [
    ...
    'disabled' => [
        ...
        'warning' => "במקרה ועברת על חוק, אנא הסבר כאן בצורה המפורטת ביותר כל מה שקרה בחודש האחרון או שלא נוכל לעשות שום דבר בנושא. לאחר פרק הזמן הזה, אתה מוזמן ליצור איתו קשר במידת הצורך. לתשומת ליבך, יצירת משתמש אחרי חסימה תוביל <strong> חסימה תמידית</strong>. אנא כתוב גם על<strong> כל משתמש שנוצר על ידך</strong>. אנו ממליצים בחום שלא תלך בדרך זו!",
