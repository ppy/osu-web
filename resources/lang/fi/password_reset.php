...
return [
    ...
    'notice' => [
        'sent' => 'Katso vahvistuskoodi sähköpostistasi.',
        'saved' => 'Uusi salasana tallennettu!',
    ],

    'started' => [
        'password' => 'Uusi salasana',
        'password_confirmation' => 'Salasanan vahvistus',
        'title' => 'Nollataan salasana käyttäjälle <strong>:username</strong>.',
        'verification_key' => 'Vahvistuskoodi',
    ],
