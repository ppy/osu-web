...
return [
    ...
    'beatmapset_revive' => ':beatmapset је оживљен од стране корисника <strong>:user</strong>.',
    'beatmapset_update' => '<strong><em>:user</em></strong> је ажурирао/ла мапу "<em>:beatmapset</em>"',
    'beatmapset_upload' => '<strong><em>:user</em></strong> је окачио нову мапу ":beatmapset"',
