...
return [
    'beatmapset_update_notice' => [
        ...
        'unwatch' => 'Apabila Anda tidak lagi ingin mengikuti beatmap ini, Anda dapat memberhentikan pengamatan Anda melalui tautan "Berhenti Ikuti" yang tertera di atas atau melalui laman Daftar Pengamatan berikut:',
    ...
    'donation_thanks' => [
        ...
        'benefit' => [
            'gift' => 'Para pengguna yang Anda hadiahkan kini dapat mengakses osu!direct dan berbagai fitur supporter lainnya.',
            'self' => 'Anda kini dapat mengakses osu!direct dan berbagai fitur supporter lainnya selama :duration.',
        ],
    ...
    'forum_new_reply' => [
        'new' => 'Kami ingin menginformasikan bahwa telah terdapat balasan baru pada ":title" sejak kunjungan terakhir Anda.',
        'subject' => '[osu!] Balasan baru pada topik ":title"',
        'unwatch' => 'Apabila Anda tidak lagi ingin mengikuti topik forum ini, Anda dapat memberhentikan pengamatan Anda melalui tautan "Berhenti Ikuti" yang tertera di atas atau melalui laman Daftar Pengamatan berikut:',
    ...
    'store_payment_completed' => [
        ...
        'questions' => "Apabila Anda memiliki pertanyaan lebih lanjut, jangan sungkan untuk membalas email ini.",
        'shipping' => 'Pengiriman',
    ...
    'user_force_reactivation' => [
        ...
        'perform_reset' => 'Anda dapat mengatur ulang kata sandi Anda melalui :url',
        'reason' => 'Alasan:',
        'subject' => 'Aktivasi Ulang Akun osu! Dibutuhkan',
    ],

    'user_notification_digest' => [
        'new' => 'Kami ingin menginformasikan bahwa telah terdapat perkembangan baru pada hal-hal yang Anda ikuti.',
