...
return [
    'event' => [
        ...
        'discussion_lock' => 'Diskusi untuk beatmap ini sudah dinonaktifkan. (:text)',
        ...
        'discussion_unlock' => 'Diskusi untuk beatmap ini sudah diaktifkan.',
        ...
        'issue_reopen' => 'Masalah :discussion yang sebelumnya sudah terjawab oleh :discussion_user dibuka kembali oleh :user.',
        ...
        'kudosu_gain' => 'Topik diskusi :discussion oleh :user mendapatkan cukup suara untuk memperoleh kudosu.',
        'kudosu_lost' => ':user kehilangan suara dari topik diskusi :discussion dan kudosu yang sebelumnya diberikan telah dianulir.',
        'kudosu_recalculate' => 'Perolehan kudosu pada topik diskusi :discussion sudah dihitung ulang.',
        ...
        'qualify' => 'Beatmap berhasil memperoleh jumlah nominasi yang dibutuhkan dan sudah berstatus Qualified.',
        'rank' => 'Ranked.',
    ...
    'type' => [
        ...
        'discussion_lock' => 'Penguncian topik diskusi',
        ...
        'discussion_unlock' => 'Pembukaan kunci topik diskusi',
