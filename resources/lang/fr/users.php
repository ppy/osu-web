...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "Mise en ligne disponible pour les <a href='".product_url('supporter_tag')."' target='_blank'>osu!supporters</a> uniquement",
        ...
        'page' => [
            ...
            'restriction_info' => "Vous devez être <a href='".product_url('supporter_tag')."' target='_blank'>osu!supporter</a> pour débloquer cette fonctionnalité.",
        ],
        'rank' => [
