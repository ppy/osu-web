...
return [
    ...
    'entry' => [
        ...
        'allowed_extensions' => 'Les fichiers :types sont acceptés',
        'max_size' => 'Taille max : :limit',
        'required_dimensions' => 'Les dimensions doivent être :widthx:height',
        'download' => 'Télécharger le .osz',
        'wrong_file_type' => 'Seuls les fichiers :types sont acceptés pour ce concours.',
