...
return [
    ...
    'voting' => [
        ...
        'login_required' => 'Por favor, conecte-se para votar.', // Base text changed from "log" to "sign"
        'best_of' => [
    ...
    'entry' => [
        '_' => 'inscrição',
        'login_required' => 'Por favor, conecte-se para participar deste concurso.', // Base text changed from "log" to "sign"
