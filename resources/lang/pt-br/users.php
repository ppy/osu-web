...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "Envio de imagem disponível apenas para <a href='".product_url('supporter-tag')."' target='_blank'>osu!supporters</a>",
        ...
        'page' => [
            ...
            'restriction_info' => "Você precisa ser um <a href='".product_url('supporter-tag')."' target='_blank'>osu!supporter</a> para desbloquear essa função.",
        ],
        'rank' => [
