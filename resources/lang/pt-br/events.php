...
return [
    ...
    'beatmapset_approve' => ':beatmapset por <strong>:user</strong> foi :aprovado!',
    'beatmapset_delete' => ':beatmapset foi excluído.',
    'beatmapset_revive' => ':beatmapset foi revivido do abandono por <strong>:user</strong>.',
    'beatmapset_update' => '<strong><em>:user</em></strong> atualizou o mapa "<em>:beatmapset</em>"',
    'beatmapset_upload' => '<strong><em>:user</em></strong> lançou um novo mapa ":beatmapset"',
    'empty' => "Este usuário não fez nada notável recentemente!",
    'rank' => '<strong><em>:user</em></strong> alcançou o rank #:rank em <em>:beatmap</em> (:mode)',
