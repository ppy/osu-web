...
return [
    ...
    'nominations' => [
        'disqualifed-at' => 'Desqualificado em :time_ago (:reason).',
        'disqualifed_no_reason' => 'sem motivo de desqualificação',
        'disqualification-prompt' => 'Motivo de desqualificação?',
        'disqualify' => 'Desqualificar',
        'incorrect_state' => 'Erro ao performar ação, atualize a página.',
        'nominate' => 'Nomear',
        'nominated-by' => 'nomeado por :users',
        'nominate-confirm' => 'Nomear esse mapa?',
        'qualified' => 'Esse mapa será ranqueado em :date, caso nenhum problema seja encontrado.',
        'qualified-soon' => 'Esse mapa será ranqueado em breve, caso nenhum problema seja encontrado.',
        'reset-confirm' => 'Você tem certeza? Postar um novo problema reiniciará as nomeações.',
