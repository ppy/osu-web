...
return [
    'match' => [
        ...
        'events' => [
            'player-left' => 'Użytkownik :user wyszedł z gry',
            'player-joined' => 'Użytkownik :user dołączył do gry',
            'player-kicked' => 'Użytkownik :user został wyrzucony z gry',
            'match-created' => 'Użytkownik :user stworzył grę',
            'match-disbanded' => 'gra została rozwiązana',
            'host-changed' => 'Użytkownik :user został hostem',
