...
return [
    ...
    'beatmapset_update' => '<strong><em>:user</em></strong> zaktualizował beatmapę "<em>:beatmapset</em>"',
    'beatmapset_upload' => '<strong><em>:user</em></strong> przesłał nową beatmapę ":beatmapset"',
    ...
    'user_support_again' => '<strong>:user</strong> ponownie zdecydował(a) się wspomóc osu! - dziękujemy za szczodrość!',
    'user_support_first' => '<strong>:user</strong> zdecydował(a) się wspomóc osu! - dziękujemy za szczodrość!',
    'user_support_gift' => '<strong>:user</strong> otrzymał prezent w postaci statusu donatora!',
