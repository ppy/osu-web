...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "Upload available for <a href='".product_url('supporter_tag')."' target='_blank'>osu!supporters</a> only",
        ...
        'page' => [
            ...
            'restriction_info' => "You need to be an <a href='".product_url('supporter_tag')."' target='_blank'>osu!supporter</a> to unlock this feature.",
        ],
        'rank' => [
