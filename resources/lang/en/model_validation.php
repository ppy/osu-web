...
return [
    ...
    'user' => [
        ...
        'username_available_in_days' => 'This username will be available for use in :count day.|This username will be available for use in :count days.',
        'username_available_in_hours' => 'This username will be available for use in :count hour.|This username will be available for use in :count hours.',
