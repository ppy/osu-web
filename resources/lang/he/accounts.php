...
return [
    'edit' => [
        ...
        'avatar' => [
            'title' => 'תמונת פרופיל',
            'rules' => 'אנא וודא שהתמונה שלך קשורה ל :link<br/>זה אומר שזה צריך להיות <strong> מתאים לכל הגילים</strong> ובלי תוכן לא נעות, שפה לא נעותה או תוכן מרמז.',
    ...
    'notifications' => [
        ...
        'comment_reply' => 'לקבל התראות על מענה לתגובה שלך',
        'title' => 'הודעות',
