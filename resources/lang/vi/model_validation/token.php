...
return [
    'invalid_scope' => [
        ...
        'client_missing_owner' => 'Client thiếu chủ sở hữu.',
        'client_unauthorized' => 'Client không được cấp quyền.',
        'delegate_bot_only' => 'Delegation với Client Credentials chỉ khả dụng cho bot.',
        ...
        'bot_only' => 'Chỉ bot hoặc client do bạn sở hữu mới dùng được scope này.',
    ],
];
