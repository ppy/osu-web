...
return [
    ...
    'show' => [
        ...
        'entered' => 'Bạn đã đăng kí giải đấu này.<br><br>Lưu ý rằng điều này <b>không</b> có nghĩa là bạn đã được chia đội.<br><br>Hướng dẫn thêm sẽ được gửi cho bạn qua email vào khoảng thời gian gần ngày thi đấu, vì thế hãy chắc chắn rằng email của tài khoản osu! của bạn hợp lệ!',
