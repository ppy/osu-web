...
return [
    'box' => [
        'sent' => '인증 코드 메일이 :mail 으로 발송되었습니다. 코드를 입력해 주세요.',
        'title' => '계정 인증',
        'verifying' => '인증하는 중...',
        'issuing' => '새 코드를 발급 중...',
    ...
    'box_totp' => [
        ...
        'info' => [
            ...
            'mail_fallback' => [
                '_' => '앱을 사용할 수 없는 상황이라면, :link받을 수도 있습니다.',
                'link' => '이메일로 인증',
            ],
        ],
    ],
    ...
    'errors' => [
        ...
        'totp_used_key' => '이미 사용된 인증 코드입니다. 잠시 기다렸다가 새로운 코드를 입력해 주세요.',
        'totp_gone' => '인증 토큰이 삭제되어 이메일 인증으로 전환되었습니다. 인증 메일이 발송되었으니 확인해주세요.',
