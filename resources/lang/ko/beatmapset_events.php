...
return [
    'event' => [
        ...
        'disqualify' => ':user님에 의해 디스퀄리파이 되었습니다. 이유: :discussion (:text).',
        'disqualify_legacy' => ':user님에 의해 디스퀄리파이 됨. 이유: :text.',
