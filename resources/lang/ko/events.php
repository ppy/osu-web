...
return [
    ...
    'rank' => ':user님이 :beatmap (:mode) 맵에서 :rank등을 기록하셨어요.',
    'rank_lost' => '<strong><em>:user</em></strong>님이 <em>:beatmap</em> (:mode)맵에서 1등 자리를 빼앗겼습니다.',
    'user_support_again' => '<strong>:user</strong>님이 다시 한 번 osu!를 지원하기로 결정하셨어요. - 감사합니다!',
    'user_support_first' => '<strong>:user</strong>님이 osu! 서포터가 되셨습니다. - 감사합니다!',
    'user_support_gift' => '<strong>:user</strong>님이 osu! 서포터를 선물받았습니다!',
    'username_change' => '<strong>:previousUsername</strong>님이 이름을 <strong><em>:user</em></strong>(으)로 변경하셨어요!',
