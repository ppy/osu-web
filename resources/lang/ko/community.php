...
return [
    'support' => [
        ...
        'dev_quote' => 'osu!는 완전한 무료 게임입니다, 그렇지만 osu!를 운영하는 데에는 무료가 아닙니다. 
        서버 운용비와 고품질의 네트워크 환경부터 시작해서 시스템과 커뮤니티를 유지/보수하며 쓰는 시간, 각종 대회에 내걸 보상, 사용자들의 질문에 답변하는 등 여러분을 만족하게 하려고 꽤 많은 돈을 소비하거든요!
