...
return [
    ...
    'password_reset' => [
        ...
        'requested' => 'Sen veya seni taklit eden biri osu! hesabın için bir şifre sıfırlama isteğinde bulundu.',
    ...
    'user_verification' => [
        ...
        'action_from' => [
            '_' => 'Hesabında :country bölgesinden gerçekleştirilen bir eylem için doğrulama gerekiyor.',
