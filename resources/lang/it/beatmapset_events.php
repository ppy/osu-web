...
return [
    'event' => [
        ...
        'discussion_post_delete' => 'Un moderatore ha cancellato un posto dalla discussione :discussion.',
        ...
        'disqualify' => 'Squalificato da :user. Motivazione: :discussione (:text).',
        'disqualify_legacy' => 'Squalificato da :user. Motivazione: :text.',
        ...
        'kudosu_lost' => 'La discussione :discussion di :user ha perso voti e il kudosu permesso è stato permesso.',
        'kudosu_recalculate' => 'La discussione :discussion ha ricevuto un ricalcolo del kudosu permesso.',
        'nominate' => 'Nominato da :user.',
