...
return [
    'invalid_scope' => [
        ...
        'delegate_bot_only' => 'La delegazione con le Credenziali Client è disponibile solo ai bot.',
        ...
        'bot_only' => 'Questo scope è disponibile solo per i bot o i tuoi client.',
    ],
];
