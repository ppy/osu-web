...
return [
    ...
    'user_support_first' => '<strong>:user</strong> 成爲了 osu!支持者 - 感謝您的慷慨捐贈！',
    'user_support_gift' => '<strong>:user</strong> 成爲了 osu!支持者 - 來自匿名玩家的贈予！',
    'username_change' => '<strong>:previousUsername</strong> 將名字改爲 <strong><em>:user</strong></em>！',
];
