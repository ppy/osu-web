    ...
    'support' => [
        ...
        'perks' => [
            ...
            'more_beatmaps' => [
                ...
                'description' => 'Максимальное количество неранкнутых карт, которое вы можете добавить, начинается с одного значения и увеличивается по мере того, как ваши карты становятся ранкнутыми (ограниченно).<br/><br/>Обычно это 4 карты изначально, плюс одна за каждую ранкнутую (до двух). С osu!supporter: 8 карт изначально, плюс одна за каждую ранкнутую (до 12).',
            ],
            'friend_filtering' => [
