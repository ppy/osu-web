...
return [
    'support' => [
        ...
        'why-support' => [
            ...
            'ads' => [
                'title' => 'Обеспечение независимости osu!',
        ...
        'perks' => [
            ...
            'mod_filtering' => [
                'title' => 'Фильтрация по модам',
                'description' => 'Интересуетесь только теми, кто играет с HDHR? Нет проблем!',
            ],

            'auto_downloads' => [
                'title' => 'Автоматические загрузки',
                'description' => 'Автоматическая загрузка карт при игре в мультиплеере, наблюдении за другими игроками или переходу по ссылке в чате!',
            ],
            ...
            'customisation' => [
                ...
                'description' => "Выделитесь возможностью загрузить свою обложку профиля, заполнить личный раздел \"обо мне!\" или изменить цвет профиля на свой вкус.",
            ],

            'beatmap_filters' => [
                'title' => 'Фильтры карт',
                'description' => 'Фильтрация карт в поиске по статусу прохождения или достигнутому рангу.',
            ],
            ...
            'skinnables' => [
                'title' => 'Расширенные возможности для скина',
                'description' => 'Ещё больше функций скина, как пример, для изменения фона главного меню.',
            ],
        ...
        'supporter_status' => [
            'contribution_with_duration' => 'Большое Вам спасибо за постоянную поддержку! За всё время вы пожертвовали :dollars, получив взамен тег "osu!supporter" на :duration.',
