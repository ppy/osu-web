...
return [
    ...
    'post' => [
        'confirm_destroy' => 'Удалить пост?',
        'confirm_restore' => 'Восстановить пост?',
    ...
    'search' => [
        ...
        'post_number_input' => 'введи номер поста',
        'total_posts' => ':posts_count постов',
    ],
    'subforums' => 'Подфорумы',
    ...
    'topic' => [
        ...
        'go_to_latest' => 'перейти к последнему посту',
        'jump' => [
            'enter' => 'нажми для ввода определённого номера поста',
            'first' => 'перейти к первому посту',
            'last' => 'перейти к последнему посту',
            'next' => 'пропустить следующие 10 постов',
            'previous' => 'вернуться на предыдущие 10 постов',
        ],
    ...
    'topic_watches' => [
        'index' => [
            'title' => 'Подписки на темы',
            'title_compact' => 'подписки',
            'title_main' => '<strong>Подписки</strong>',

            'box' => [
                'total' => 'Подписок на тем',
                'unread' => 'Тем с новыми ответами',
            ],
            'info' => [
                'total' => 'Ты подписан на :total тем.',
