...
return [
    ...
    'post' => [
        'confirm_destroy' => 'Вы точно хотите удалить этот ответ?',
        'confirm_restore' => 'Вы точно хотите восстановить этот ответ?',
    ...
    'topic' => [
        'confirm_destroy' => 'Вы точно хотите удалить эту тему?',
        'confirm_restore' => 'Вы точно хотите восстановить эту тему?',
