...
return [
    ...
    'show' => [
        ...
        'lazer_only' => [
            'title' => 'Только в Lazer',
            'description' => 'Из-за некоторых нестандартных механик эту карту можно пройти только в osu!lazer.',

            'scoreboard_switch_mode' => [
                '_' => ':enable_link чтобы посмотреть рекорды, поставленные на этой карте.',
                'enable_link' => 'Включите Lazer-рекорды,',
            ],
        ],
        ...
        'scoreboard' => [
            ...
            'supporter-only' => 'Приобретите тег osu!supporter, чтобы получить доступ к рейтингу по друзьям, стране или модам!',
        ...
        'stats' => [
            ...
            'no_favourites' => 'Пока нет ни у кого в избранных',
        ],
