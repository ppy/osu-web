...
return [
    ...
    'notifications' => [
        ...
        'tooltips' => [
            'beatmap_owner_change' => 'когда вас назначают гостевым маппером какой-либо сложности карты',
            'beatmapset:modding' => 'когда в обсуждениях ваших карт, на которые вы подписаны, появляются обновления, проблемы или предложения',
            'channel_mention' => 'когда вас упоминают в публичном канале',
            'channel_message' => 'когда вы получаете личное сообщение',
            'channel_team' => 'когда в ваш командный чат приходит новое сообщение',
            'comment_new' => 'когда под чем-либо, на что вы подписаны, появляются новые комментарии',
            'forum_topic_reply' => 'когда в темах форума, на которые вы подписаны, появляются новые ответы',
            'mapping' => 'когда маппер, на которого вы подписаны, публикует новую карту',
            'news_post' => 'когда появляются свежие новости',
        ],
    ],
