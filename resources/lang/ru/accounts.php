...
return [
    'edit' => [
        ...
        'avatar' => [
            'title' => 'Аватар',
            'rules' => 'Убедитесь, что ваш аватар не нарушает :link.<br/>Он должен <strong>подходить для всех возрастов</strong>: никакой наготы, ругательств или вызывающего контента.',
