...
return [
    ...
    'notifications' => [
        ...
        'news_post' => 'получать уведомления о новостях в следующих категориях',
        'title' => 'Уведомления',
...
',
    ...
    'options' => [
        'beatmapset_show_anime_cover' => 'показывать обложки карт в аниме-стиле',
    ...
    'user_totp' => [
        'title' => 'Приложение для аутентификации (2FA)',
        'usage_note' => 'Использовать одноразовый пароль в приложении вместо подтверждения по почте. Верификация по электронной почте всё ещё останется запасным вариантом.',

        'button' => [
            'remove' => 'Удалить',
            'setup' => 'Добавить приложение',
        ],
        'status' => [
            'label' => 'статус',
