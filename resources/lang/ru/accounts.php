...
',
    ...
    'user_totp' => [
        ...
        'usage_note' => 'Использовать одноразовый пароль в приложении вместо подтверждения по почте. Верификация по электронной почте все ещё останется запасным вариантом.',
