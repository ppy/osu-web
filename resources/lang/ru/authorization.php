...
return [
    ...
    'require_login' => 'Войдите, чтобы продолжить.',
    ...
    'beatmapset' => [
        ...
        'metadata' => [
            'nominated' => 'Вы не можете изменить метаданные номинированной карты. Чтобы исправить возможные ошибки, свяжитесь с номинаторами или членом NAT.',
        ],

        'rate' => [
            'owner' => 'Вы не можете оценивать набор карт, в создании которого вы участвовали.',
            'status' => 'Вы не можете оценить набор карт с этим статусом.',
        ],
    ],

    'beatmap_tag' => [
        'store' => [
            'no_score' => 'Сыграйте эту карту, чтобы добавить тег.',
        ],
    ],

    'chat' => [
        'blocked' => 'Вы не можете отправить сообщение пользователю, который заблокировал вас или которого заблокировали вы.',
        'friends_only' => 'Этот пользователь блокирует сообщения ото всех, кроме друзей.',
    ...
    'forum' => [
        'moderate' => [
            'no_permission' => 'У вас недостаточно прав на модерацию этого форума.',
        ],
        ...
        'post' => [
            ...
            'edit' => [
                ...
                'no_forum_access' => 'Необходим доступ к запрашиваемому форуму.',
                'no_permission' => 'У вас недостаточно прав на редактирование этого поста.',
                'not_owner' => 'Редактировать пост может только его автор.',
                'topic_locked' => 'Нельзя редактировать пост в закрытой теме.',
            ],

            'store' => [
                'play_more' => 'Пожалуйста, поиграйте в osu!, прежде чем начать создавать темы! Если у вас возникли проблемы, попробуйте сообщить об этом уже в существующей теме "Вопросы и проблемы" на форуме "Русский".',
                'too_many_help_posts' => "Поиграйте в osu! ещё немного, прежде чем снова публиковать посты. Если вы всё еще испытываете проблемы с игрой, напишите на почту support@ppy.sh", // FIXME: unhardcode email address.
            ],
        ],
        ...
        'topic' => [
            'reply' => [
                ...
                'locked' => 'Эта тема закрыта — ответы отключены.',
                'no_forum_access' => 'Необходим доступ к запрашиваемому форуму.',
                'no_permission' => 'У вас недостаточно прав для ответа.',
            ...
            'store' => [
                'no_forum_access' => 'Необходим доступ к запрашиваемому форуму.',
                'no_permission' => 'У вас недостаточно прав на создание новой темы.',
    ...
    'team' => [
        'application' => [
            'store' => [
                'already_member' => "Вы уже вступили в эту команду.",
                'already_other_member' => "Вы уже вступили в другую команду.",
                'currently_applying' => 'У вас уже есть запрос на вступление в другую команду.',
                'team_closed' => 'Эта команда не принимает запросы на вступление на данный момент.',
                'team_full' => "Эта команда уже переполнена и больше не может принять новых участников.",
            ],
        ],
        'part' => [
            'is_leader' => "Капитан не может покинуть собственную команду.",
            'not_member' => 'Вы не являетесь участником команды.',
        ],
        'store' => [
            'require_supporter_tag' => 'Для создания команды необходим тег osu!supporter.',
        ],
    ],
