    ...
    'forum' => [
        ...
        'post' => [
            ...
            'store' => [
                ...
                'too_many_help_posts' => "Вы должны поиграть в игру подольше, прежде чем создавать дополнительные посты. Если у вас все еще имеются проблемы с игрой, напишите на почту support@ppy.sh", // FIXME: unhardcode email address.
            ],
        ],
