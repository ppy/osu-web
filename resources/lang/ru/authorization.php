...
return [
    ...
    'chat' => [
        ...
        'message' => [
            'send' => [
                ...
                'not_allowed' => 'Невозможно отправить сообщение пока вы ограничены/сайленсед.',
            ],
        ],
    ],
        ...
        'topic' => [
            ...
            'vote' => [
                ...
                'user' => [
                    'require_login' => 'Войдите для ответа.',
                    'restricted' => "Нельзя ответить пока аккаунт ограничен",
                    'silenced' => "Нельзя ответить пока сайленсед.",
                ],
            ],
    ...
    'silenced' => "Нельзя делать это пока вы сайленсед.",
