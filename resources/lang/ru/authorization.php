...
return [
    ...
    'forum' => [
        'post' => [
            ...
            'store' => [
                'play_more' => 'Пожалуйста, перед тем как писать что-либо на форуме, поиграйте в игру. Если у вас имеются проблемы с игрой, попробуйте написать об этом на форуме «Помощи и поддержки».',
                'too_many_help_posts' => "Прежде чем вы сможете создавать дополнительные посты, вы должны поиграть в игру подольше. Если у вас имеются проблемы при игре, напишите на support@ppy.sh", // FIXME: unhardcode email address.
            ],
        ],
        ...
        'topic' => [
            'reply' => [
                ...
                'user' => [
                    ...
                    'silenced' => "Нельзя ответить пока заглушен.",
                ],
            ],
    ...
    'silenced' => "Нельзя делать это пока вы ограничены.",

    'restricted' => "Нельзя делать это пока вы заглушены.",
    ...
    'user' => [
        'page' => [
            'edit' => [
                ...
                'require_supporter_tag' => 'Необходим статус osu!supporter.',
            ],
        ],
    ],
];
