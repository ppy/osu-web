...
return [
    ...
    'beatmap_discussion' => [
        ...
        'nominate' => [
            'exhausted' => 'Достигнут ваш лимит номинаций за день, повторите попытку завтра.',
        ...
        'vote' => [
            'bot' => "Нельзя проголосовать за публикацию от бота",
    ...
    'beatmap_discussion_post' => [
        'destroy' => [
            ...
            'resolved' => 'Вы не можете удалить публикацию в решённом обсуждении.',
            'system_generated' => 'Нельзя удалить автоматически созданную публикацию.',
        ],

        'edit' => [
            'not_owner' => 'Только автор может редактировать публикацию.',
            'resolved' => 'Нельзя отредактировать публикацию в решённом обсуждении.',
    ...
    'comment' => [
        ...
        'update' => [
            'deleted' => "Нельзя редактировать удалённую публикацию.",
        ],
    ],
    ...
    'forum' => [
        ...
        'post' => [
            ...
            'store' => [
                ...
                'too_many_help_posts' => "Вы должны поиграть в игру подольше, прежде чем создавать дополнительные публикации. Если у вас всё ещё имеются проблемы с игрой, напишите на почту support@ppy.sh", // FIXME: unhardcode email address.
            ],
        ],

        'topic' => [
            'reply' => [
                'double_post' => 'Пожалуйста, отредактируйте ваш последнюю публикацию, не создавайте новую.',
