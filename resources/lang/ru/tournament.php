...
return [
    ...
    'show' => [
        ...
        'state' => [
            ...
            'registration_closed' => 'Регистрация на этот турнир закрыта. Для просмотра последних изменений, откройте информационную страницу.',
            'running' => 'Этот турнир уже проводится. Для просмотра последних изменений, откройте информационную страницу.',
        ],
    ],
