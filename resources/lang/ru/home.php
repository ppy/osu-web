...
return [
    ...
    'search' => [
        ...
        'beatmapset' => [
            'login_required' => 'Войдите в аккаунт, чтобы искать по картам',
        ...
        'forum_post' => [
            ...
            'login_required' => 'Войдите в аккаунт, чтобы искать по форуму',
        ...
        'team' => [
            'login_required' => 'Войдите в аккаунт, чтобы искать по командам',
            'more_simple' => 'Посмотреть все результаты поиска среди команд',
        ],

        'user' => [
            'login_required' => 'Войдите в аккаунт, чтобы искать по пользователям',
