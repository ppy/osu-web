...
return [
    ...
    'discussions' => [
        ...
        'reply_placeholder' => 'Введите свой ответ',
        ...
        'message_hint' => [
            'in_general' => 'Эта публикация пойдёт в общую ветку отзывов. Чтобы изменить эту карту, начните своё сообщение с временной отметкой (к примеру 00:12:345).',
            'in_timeline' => 'Для модерирования нескольких временных отметок, опубликуйте несколько сообщений (по одному на отметку).',
        ],

        'message_placeholder' => [
            'general' => 'Введите здесь, чтобы создать публикацию в «Общий (:version)»',
            'generalAll' => 'Введите здесь, чтобы создать публикацию в «Общий (Все сложности)»',
            'review' => 'Введите здесь, чтобы оставить отзыв',
            'timeline' => 'Введите здесь, чтобы создать публикацию в временную шкалу (:version)',
        ],
