...
return [
    ...
    'listing' => [
        'search' => [
            ...
            'rank_filter_note' => 'Количество карт и результатов на них, отображенное на этой странице, основано на ваших наилучших "стандартизированных" (вида "lazer") рекордах на картах.',
