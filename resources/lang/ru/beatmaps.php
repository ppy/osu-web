...
return [
    ...
    'discussions' => [
        ...
        'message_placeholder' => 'Нажми сюда для публикации',
    ...
    'status' => [
        ...
        'loved' => 'Любимые',
        'faves' => 'Избранные',
        'modreqs' => 'Запросы нового режима',
        'pending' => 'Ожидающие',
        'graveyard' => 'Забытое', // TODO: найти перевод лучше
        'my-maps' => 'Мои карты',
    ],
    'genre' => [
        'any' => 'Все',
        ...
        'novelty' => 'Новые',
        'hip-hop' => 'Хип-хоп',
        'electronic' => 'Электроник', // TODO: найти перевод лучше
    ],
    'mods' => [ // Кажется, что перевод не нуждается
        'NF' => 'No Fail',
        'EZ' => 'Easy Mode',
        'HD' => 'Hidden',
        'HR' => 'Hard Rock',
