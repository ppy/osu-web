...
return [
    ...
    'discussions' => [
        ...
        'new' => [
            'pin' => 'Закрепить',
            'timestamp' => 'Тайм-код',
            'timestamp_missing' => 'Нажмите Ctrl + C в режиме редактирования, чтобы скопировать тайм-код и вставить в сообщение!',
            'title' => 'Новый отзыв',
            'unpin' => 'Открепить',
        ],
        ...
        'review' => [
            ...
            'embed' => [
                ...
                'timestamp' => [
                    ...
                    'diff' => 'Если :type начинается с тайм-кода, оно появится в разделе "Тайм-коды".',
                ],
            ],
            'insert-block' => [
