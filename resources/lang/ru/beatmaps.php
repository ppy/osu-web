...
return [
    ...
    'hype' => [
        ...
        'confirm' => "Вы уверены? Будет использован 1 из :n хайпов. Это действие необратимо.",
        'explanation' => 'Хайпаните эту карту, чтобы повысить её шансы на номинации и выход в рейтинг!',
        'explanation_guest' => 'Войдите в аккаунт, чтобы хайпануть эту карту и повысить её шансы на номинации и выход в рейтинг!',
    ...
    'listing' => [
        'search' => [
            ...
            'rank_filter_note' => 'Количество карт и результатов на них, отображённое на этой странице, основано на ваших наилучших "стандартизированных" (вида "lazer") рекордах на картах.',
            ...
            'tag_picker' => [
                'tooltip' => 'поиск по тегам от игроков',
                'prompt' => 'начните печатать',
            ],
        ],
    ],
    'general' => [
