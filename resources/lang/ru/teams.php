...
return [
    ...
    'create' => [
        ...
        'intro' => [
            'description' => "Играйте вместе с друзьями, создав свою команду или заводите новых, вступая в существующие! Сейчас вы не состоите в команде. Вступайте в :search_link на её странице или создайте новую здесь.",
            'search_link' => 'существующую команду',
            'title' => 'Команда!',
        ],
    ],
