...
return [
    ...
    'param_too_large' => 'Параметр :name не может принимать более :count_delimited значения|Параметр :name не может принимать более :count_delimited значений|Параметр :name не может принимать более :count_delimited значений',
    'supporter_only' => 'Этой функцией можно воспользоваться только с тегом osu!supporter.',
    ...
    'scores' => [
        'invalid_id' => 'Недопустимый id рекорда.',
    ],
    'search' => [
