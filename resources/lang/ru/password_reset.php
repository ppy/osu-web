...
return [
    'button' => [
        'cancel' => 'Отмена',
        'resend' => 'Еще раз отправить код на почту',
    ...
    'error' => [
        ...
        'is_privileged' => 'Пожалуйста, свяжитесь с администратором высокого уровня для восстановленная доступа к аккаунту.',
        'missing_key' => 'Это поле обязательно для заполнения.',
    ...
    'notice' => [
        'sent' => 'Проверьте свою почту: Вам должно было прийти письмо с кодом подтверждения.',
    ...
    'started' => [
        ...
        'title' => 'Сброс пароля аккаунта с никнеймом <strong>:username</strong>.',
