...
return [
    ...
    'voting' => [
        ...
        'best_of' => [
            'none_played' => "Не похоже, что вы играли в карты, квалифицированные для этого конкурса!",
        ],
    ...
    'entry' => [
        ...
        'allowed_extensions' => 'Принимаются файлы :types',
        'max_size' => 'Максимальный размер: :limit',
        'required_dimensions' => 'Размеры должны быть строго :widthx:height',
        'download' => 'Скачать .osz',
        'wrong_file_type' => 'Для этого конкурса принимаются только файлы формата :types',
