...
return [
    ...
    'voting' => [
        ...
        'login_required' => 'Войди для голосования.', // Base text changed from "log" to "sign"
        'best_of' => [
    ...
    'entry' => [
        '_' => 'заявка',
        'login_required' => 'Войди, чтобы участвовать в этом конкурсе.', // Base text changed from "log" to "sign"
