...
return [
    ...
    'popup_login' => [
        ...
        'register' => [
            'download' => 'Скачать',
            'info' => 'Скачайте osu!, чтобы его создать!',
            'title' => "Нет аккаунта?",
        ],
    ],
    ...
    'popup_user' => [
        'links' => [
            ...
            'logout' => 'Выйти',
            'profile' => 'Мой профиль',
            'scoring_mode_toggle' => 'Классический вид очков',
            'scoring_mode_toggle_tooltip' => 'Приближённо возвращает игровые очки к классическому неограниченному алгоритму подсчёта',
            'team' => 'Моя команда',
        ],
    ],
