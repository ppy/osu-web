...
return [
    ...
    'user_support_first' => '<strong>:user</strong> приобрёл тег osu!саппортера - благодарим за Вашу поддержку!',
    'user_support_gift' => '<strong>:user</strong> получил тег osu!саппортер в подарок!',
