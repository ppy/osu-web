...
return [
    ...
    'login' => [
        ...
        'email_login_disabled' => 'Вход с помощью электронной почты в настоящее время отключен. Вместо этого, пожалуйста, используйте имя пользователя.',
    ...
    'show' => [
        ...
        'extra' => [
            ...
            'kudosu' => [
                ...
                'entry' => [
                    ...
                    'beatmap_discussion' => [
                        ...
                        'delete' => [
                            'reset' => 'Потеряно :amount за удаление ответа в публикации: :post',
                        ],

                        'restore' => [
                            'give' => 'Получено :amount за восстановление ответа в публикаци: :post',
                        ],

                        'vote' => [
                            'give' => 'Получено :amount за получение голосов в публикации: :post',
                            'reset' => 'Потеряно :amount за потерю голосов в публикации: :post',
                        ],

                        'recalculate' => [
                            'give' => 'Получено :amount за перерасчёт голосов в публикации: :post',
                            'reset' => 'Потеряно :amount за перерасчёт голосов в публикации: :post',
                        ],
                    ],

                    'forum_post' => [
                        'give' => 'Получено :amount от :giver за сообщение в публикации: :post',
                        'reset' => ':giver сбросил кудосу за ответ в публикации: :post',
                        'revoke' => ':giver отнял кудосу за ответ в публикации: :post',
                    ],
                ],
            ...
            'posts' => [
                'title' => 'Публикации',
                'title_longer' => 'Недавние публикации',
                'show_more' => 'загрузить больше публикаций',
            ],
            'recent_activity' => [
        ...
        'post_count' => [
            '_' => 'Написал :link',
            'count' => ':count публикация|:count публикации|:count публикаций',
        ],
        'rank' => [
