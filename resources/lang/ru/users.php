...
return [
    ...
    'report' => [
        ...
        'dmca' => [
            'message_1' => [
                '_' => 'Пожалуйста, сообщите о нарушении авторских прав, отправив DMCA-жалобу на адрес электронной почты :mail в соответствии с :policy.',
                'policy' => 'политикой osu! в отношении авторского права',
            ],
            'message_2' => 'Применимо к случаям, когда аудиотреки, визуальное содержимое или игровые уровни карты используются без надлежащего разрешения.',
        ],
    ...
    'show' => [
        ...
        'edit' => [
            ...
            'default_playmode' => [
                ...
                'set' => 'установить :mode основным режимом игры',
            ],
        ...
        'stats' => [
            ...
            'hits_per_play' => 'Попаданий в среднем за игру',
            'level' => 'Уровень :level',
