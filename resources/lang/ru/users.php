...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "Загрузка своих обложек доступна только для <a href='".product_url('supporter-tag')."' target='_blank'>osu! саппортеров</a>",
        ...
        'page' => [
            ...
            'restriction_info' => "Ты должен иметь тег <a href='".product_url('supporter-tag')."' target='_blank'>osu!саппортера</a> для разблокировки данной особенности.",
        ],
        'rank' => [
