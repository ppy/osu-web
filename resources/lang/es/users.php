...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "Subida solo disponible para <a href='".product_url('supporter-tag')."' target='_blank'>osu!supporters</a>",
        ...
        'page' => [
            ...
            'restriction_info' => "Necesitas ser un <a href='".product_url('supporter-tag')."' target='_blank'>osu!supporter</a> para desbloquear esta característica.",
        ],
        'rank' => [
