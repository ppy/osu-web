...
return [
    ...
    'show' => [
        ...
        'score_processing' => [
            'title' => 'Un nuevo algoritmo de calificación por estrellas / PP está :link.',
            'title_link' => 'siendo implementado',
            'message' => 'Las puntuaciones recientes pueden no aparecer de inmediato en los perfiles de los usuarios.',
        ],
        'season_stats' => [
