...
return [
    ...
    'card' => [
        'members' => ':count_delimited miembro|:count_delimited miembros',
    ],
    ...
    'create' => [
        ...
        'intro' => [
            'description' => "Juega con tus amigos, con los que ya tienes o con los nuevos. Actualmente no estás en un equipo. Únete a un :search_link visitando su página de equipo o crea tu propio equipo desde esta página.",
