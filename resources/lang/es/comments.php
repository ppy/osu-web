...
return [
    ...
    'empty_other' => 'Aún no hay otros comentarios.',
    ...
    'editor' => [
        'textarea_hint' => [
            '_' => 'Presiona enter para :action. Usa mayús+enter para saltar de linea.',
            'edit' => 'guardar',
            'new' => 'publicar',
            'reply' => 'responder',
        ],
    ...
    'guest_button' => [
        'new' => 'Inicie sesión para comentar',
        'reply' => 'Inicie sesión para responder',
    ],
