...
return [
    ...
    'nominate' => [
        ...
        'full_bn_required' => 'Осы квалификациялық номинациясын беру үшін сіз толық номинатор болуыңыз керек.',
    ...
    'show' => [
        ...
        'details' => [
            ...
            'favourite_login' => 'осы картаны ұнамдыларға қосу үшін жүйеге кіріңіз',
            'logged-out' => 'кез келген карталарды жүктеп алу үшін жүйеге кіруіңіз керек!',
