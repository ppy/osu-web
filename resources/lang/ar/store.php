...
return [
    ...
    'checkout' => [
        ...
        'pending_checkout' => [
            'line_1' => 'تم بدء عملية دفع سابقة لكنها لم تكتمل.',
            'line_2' => 'استأنف عملية الدفع عن طريق اختيار طريقة الدفع.',
        ],
    ],
    ...
    'invoice' => [
        'contact' => 'جهة الإتصال:',
        'date' => 'التاريخ:',
        'echeck_delay' => 'نظرًا لأن عملية الدفع كانت عبر eCheck، يُرجى الانتظار حتى 10 أيام إضافية حتى تتم معالجة الدفع عبر PayPal!',
        'echeck_denied' => '',
    ...
    'username_change' => [
        ...
        'require_login' => [
            '_' => 'يجب أن تكون :link لتغيير اسمك!',
            'link_text' => 'مُسَجَل',
        ],
    ],
