...
return [
    ...
    'discussions' => [
        ...
        'status-messages' => [
            ...
            'ranked' => 'اصبحت هذه الخريطة مقيّمة في :date!',
    ...
    'nominations' => [
        ...
        'love' => 'حُب',
        'love_choose' => 'اختر صعوبة لـ محبوبة',
        ...
        'remove_from_loved' => 'إزالة من خانة "محبوبة"',
        'remove_from_loved_prompt' => 'سبب الإزالة من خانة "محبوبة":',
        ...
        'rank_estimate' => [
            '_' => 'هذه الخريطة مقدرة بأن تصبح مقيّمة في :date إذا لم يتم العثور على أي مشاكل. انها#:position في :queue.',
