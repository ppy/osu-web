...
return [
    ...
    'oauth' => [
        'client' => [
            'too_many' => 'تم تجاوز الحد الأقصى المسموح به لعدد تطبيقات OAuth.',
            'url' => 'يرجى إدخال عناوين URL صحيحة.',
    ...
    'user' => [
        ...
        'invalid_discord' => 'اسم مستخدم Discord غير صالح.',
        ...
        'wrong_email_confirmation' => 'تأكيد البريد الإلكتروني غير متطابق',
        ...
        'change_username' => [
            ...
            'supporter_required' => [
                '_' => 'يجب أن تمتلك :link لتغيير اسمك!',
                'link_text' => 'اِدعم osu!',
            ],
            'username_is_same' => 'هذا هو اسم المستخدم الخاص بك حاليًا أيها السخيف!',
        ],
    ],
