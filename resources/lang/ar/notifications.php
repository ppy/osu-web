    ...
    'item' => [
        'beatmapset' => [
            ...
            'beatmapset_state' => [
                ...
                'beatmapset_love_compact' => 'أرتقت الخريطة لتصبح محبوبة',
                ...
                'beatmapset_rank' => '":title" اصبحت الأن مقيّمة',
                'beatmapset_rank_compact' => ' كانت هذه الخريطة مقيّمة',
                'beatmapset_remove_from_loved' => '":title" تمت ازالتها من "خرائط محبوبة"',
                'beatmapset_remove_from_loved_compact' => 'أُزيلت الخريطة من "خرائط محبوبة"',
    ...
    'mail' => [
        'beatmapset' => [
            ...
            'beatmapset_state' => [
                ...
                'beatmapset_love' => '":title" اصبخت الأن محبوبة',
                'beatmapset_nominate' => 'اصبحت ":title" مرشحة',
                'beatmapset_qualify' => '":title" حصلت على ترشيحات كافية ودخلت حالة التصنيف',
                'beatmapset_rank' => '":title" اصبحت الأن مقيّمة',
                'beatmapset_remove_from_loved' => '":title" أُزيلَت مِن "خرائط محبوبة"',
                'beatmapset_reset_nominations' => 'تم اعادة تعيين ترشيحات ":title"',
            ],
