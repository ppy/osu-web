...
return [
    ...
    'beatmap_discussion_post' => [
        'destroy' => [
            'not_owner' => 'يمكنك حذف مشاركاتك فقط.',
            'resolved' => 'لا يمكنك حذف مشاركة تابعة لـ مناقشة مغلقة.',
    ...
    'beatmapset' => [
        'discussion_locked' => 'هذه الخريطة مقفلة للمناقشة.',
    ...
    'beatmap_tag' => [
        'store' => [
            'no_score' => 'يجب عليك تعيين نتيجة على خريطة لإضافة علامة.',
        ],
    ],
    ...
    'chat' => [
        ...
        'no_announce' => 'ليس لديك الصلاحية لنشر الإعلان.',
        'receive_friends_only' => 'قد لا يكون المستخدم قادراً على الرد لأنك تقبل فقط الرسائل من أشخاص على قائمة أصدقائك.',
    ...
    'contest' => [
        'judging_not_active' => 'تحكيم هذه المسابقة غير جارٍ.',
    ...
    'forum' => [
        ...
        'post' => [
            ...
            'edit' => [
                ...
                'no_forum_access' => 'مطلوب الوصول إلى المنتدى المطلوب.',
                'no_permission' => 'لا توجد صلاحية للتعديل.',
            ...
            'store' => [
                ...
                'too_many_help_posts' => "تحتاج إلى لعب اللعبة أكثر قبل أن تتمكن من إنشاء منشورات إضافية. إذا كنت لا تزال تواجه مشكلة في اللعب، يُرجى مراسلة support@ppy.sh", // FIXME: unhardcode email address.
            ],
        ],
    ...
    'room' => [
        'destroy' => [
            'not_owner' => 'فقط مالك الغرفة يمكنه إغلاقها.',
        ],
    ],
    ...
    'score' => [
        'pin' => [
            ...
            'too_many' => 'تم تثبيت عدد كبير جدًا من النتائج.',
        ],
    ],
    ...
    'team' => [
        'application' => [
            'store' => [
                'already_member' => "أنت بالفعل جزء من الفريق.",
                'already_other_member' => "أنت بالفعل جزء من فريق مختلف.",
                'currently_applying' => 'لديك طلب إنضمام فريق معلق.',
                'team_closed' => 'لا يقبل الفريق حاليا أي طلبات انضمام.',
                'team_full' => "الفريق ممتلئ ولا يمكنه قبول المزيد من الأعضاء.",
            ],
        ],
        'part' => [
            'is_leader' => "لا يستطيع قائد الفريق مغادرة الفريق.",
            'not_member' => 'ليس عضوا في الفريق.',
        ],
        'store' => [
            'require_supporter_tag' => 'يلزم وجود osu!supporter لإنشاء فريق.',
        ],
    ],
