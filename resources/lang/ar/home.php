...
return [
    'landing' => [
        ...
        'slogan' => [
            ...
            'sub' => 'الإيقاع على بُعد نقرة واحدة فقط',
        ],
    ],
    ...
    'search' => [
        ...
        'forum_post' => [
            ...
            'login_required' => 'سجل الدخول للبحث في المنتدى',
        ...
        'user' => [
            'login_required' => 'سجّل الدخول للبحث عن المستخدمين',
    ...
    'download' => [
        ...
        'steps' => [
            ...
            'beatmaps' => [
                ...
                'description' => [
                    '_' => ':browse المكتبة الضخمة من الخرائظ التي أنشأها المستخدمون وابدأ اللعب!
',
                    'browse' => 'تصفح',
                ],
            ],
