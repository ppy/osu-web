...
return [
    'event' => [
        ...
        'discussion_lock' => 'A discussão para este mapa foi desativada. (:text)',
        ...
        'discussion_unlock' => 'A discussão para este mapa foi ativada.',
        ...
        'language_edit' => 'Idioma alterado de :old para :new.',
        ...
        'offset_edit' => 'O desvio do online mudou de :old para :new.',
        'qualify' => 'Este mapa atingiu o número necessário de nomeações e foi qualificado.',
        'rank' => 'Classificado.',
        'remove_from_loved' => 'Removido de Adorado por :user. (:text)',
        'tags_edit' => 'As etiquetas foram alteradas de ":old" para ":new".',
    ...
    'index' => [
        'title' => 'Eventos de conjuntos de mapas',
