...
return [
    ...
    'menu' => [
        ...
        'beatmaps' => [
            ...
            'beatmapset-watches-index' => 'lista de observação de modding',
        ...
        'user' => [
            ...
            'help' => 'Ajuda',
            'modding-history-discussions' => 'discussões de modding do utilizador',
            'modding-history-events' => 'eventos de moddings do utilizador',
            'modding-history-index' => 'historial de modding do utilizador',
            'modding-history-posts' => 'publicações de modding de utilizador',
            'modding-history-votesGiven' => 'votos de modding do utilizador dados',
            'modding-history-votesReceived' => 'votos de modding do utilizador recebidos',
        ],
        'store' => [
            '_' => 'loja',
    ...
    'popup_login' => [
        'login' => [
            ...
            'error' => [
                'email' => "Nome de utilizador ou endereço de e-mail não existente",
                'password' => 'Palavra-passe incorrecta',
            ],
        ],

        'register' => [
            'info' => "Precisa de uma conta, senhor. Porque é que não tem uma já?",
