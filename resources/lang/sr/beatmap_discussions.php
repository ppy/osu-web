...
return [
    'authorizations' => [
        'update' => [
            'null_user' => 'Морате бити пријављени да би сте могли да измените.',
    ...
    'owner_editor' => [
        'button' => 'Власник Тежине',
        'reset_confirm' => 'Ресетујте власника за ову тежину?',
        'user' => 'Власник',
        'version' => 'Тежина',
    ],
    ...
    'review' => [
        ...
        'validation' => [
            ...
            'invalid_discussion_type' => 'неважећа врста дискусије',
