...
return [
    ...
    'no-conversations' => [
        'howto' => "Започните конверзацију из корисниковог профила или са њихове popup картице.",
        'lazer' => 'Јавни канали којима се придружите преко <a href=":link">osu!lazer</a> ће такође бити видљиви овде.',
        'title' => 'још нема разговора',
    ],
