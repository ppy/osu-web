...
return [
    'landing' => [
        ...
        'online' => '<strong>:players</strong> συνδεδεμένοι αυτή τη στιγμη σε <strong>:games</strong> παιχνίδια',
    ...
    'search' => [
        'advanced_link' => 'Προηγμένη αναζήτηση',
        'button' => 'Αναζήτηση',
        ...
        'forum_post' => [
            ...
            'label' => [
                ...
                'forum_children' => 'περιλαμβάνετε subforums',
                'topic_id' => 'θέμα #',
                'username' => 'συντάκτης',
            ],
        ],
    ...
    'download' => [
        ...
        'steps' => [
            ...
            'beatmaps' => [
                ...
                'description' => [
                    '_' => ':περιηγηθείτε στην τεράστια βιβλιοθήκη των beatmaps που δημιουργούνται από τους χρήστες και αρχίστε να παίζετε!',
                    'browse' => 'περιήγηση',
                ],
            ],
        ],
    ...
    'user' => [
        ...
        'header' => [
            ...
            'messages' => 'Έχετε :count νέο μύνημα|Έχετε :count νέα μυνήματα',
            'stats' => [
    ...
    'support-osu' => [
        ...
        'body' => [
            'part-1' => 'Ξέρατε ότι το osu! τρέχει χωρίς διαφημίσεις και βασίζεταιι στους παίκτες για την υποστήριξη της ανάπτυξης και το κόστος λειτουργίας;',
