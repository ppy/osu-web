...
return [
        ...
        'message' => [
            'send' => [
                'channel' => [
                    ...
                    'moderated' => 'Το κανάλι βρίσκεται ύπο παρακολούθηση.',
    ...
    'forum' => [
        ...
        'topic' => [
            'reply' => [
                'double_post' => 'Μόλις κάνατε δημοσίευση. Περιμένετε λίγο ή επεξεργαστείτε την τελευταία σας δημοσίευση.',
            ...
            'store' => [
                ...
                'forum_closed' => 'Το φόρουμ είναι κλειστό και δε μπορείτε να δημοσιέυσετε σε αυτό.',
            ],
