...
return [
    'play_more' => 'Τι θα έλεγες να παίξεις osu! αντι αυτου;',
    ...
    'beatmap_discussion' => [
        ...
        'nominate' => [
            ...
            'set_metadata' => 'Πρέπει να ορίσετε το είδος και τη γλώσσα πριν υποβάλετε υποψηφιότητα.',
        ],
        'resolve' => [
        ...
        'vote' => [
            'bot' => "Δεν μπορώ να ψηφίσω για συζήτηση που έγινε από bot",
    ...
    'beatmap_discussion_post' => [
        'destroy' => [
            ...
            'resolved' => 'Δεν μπορείτε να διαγράψετε μια ανάρτηση μιας λυμένης συζήτησης.',
        ...
        'edit' => [
            ...
            'resolved' => 'Δεν μπορείτε να τροποποιήσετε μια ανάρτηση μιας λυμένης συζήτησης.',
            'system_generated' => 'Οι δημοσιεύσεις που έχουν δημιουργηθεί αυτόματα δεν μπορούν να επεξεργαστούν.',
        ],
    ],

    'beatmapset' => [
        'discussion_locked' => 'Αυτός ο beatmap είναι κλειδωμένος για συζήτηση.',

        'metadata' => [
            'nominated' => 'Δεν μπορείτε να αλλάξετε τα μεταδεδομένα ενός προτεινόμενου χάρτη. Επικοινωνήστε με ένα μέλος BN ή NAT αν νομίζετε ότι δεν έχει οριστεί σωστά.',
        ],
    ],

    'beatmap_tag' => [
        'store' => [
            'no_score' => 'Πρέπει να βάλεις ένα σκορ στο beatmap σου για να προσθέσεις μια ετικέτα.',
        ],
    ],
    ...
    'chat' => [
        ...
        'no_announce' => 'Δεν έχεις άδεια για να δημοσιεύσεις ανακοίνωση.',
        'receive_friends_only' => 'Ο χρήστης μπορεί να μην είναι σε θέση να απαντήσει, επειδή δέχεστε μόνο μηνύματα από άτομα στη λίστα φίλων σας.',
    ...
    'comment' => [
        'store' => [
            'disabled' => 'Τα σχόλια είναι απενεργοποιημένα',
        ],
        'update' => [
    ...
    'contest' => [
        'judging_not_active' => 'Η κριτική για αυτό τον διαγωνισμό δεν είναι ενεργό.',
    ...
    'forum' => [
        ...
        'post' => [
            ...
            'edit' => [
                ...
                'no_forum_access' => 'Απαιτείται πρόσβαση για το συγκεκριμένο φόρουμ.',
                'no_permission' => 'Δεν έχεις άδεια για επεξεργασία.',
                'not_owner' => 'Μόνο ο δημιουργός της δημοσίευσης μπορεί να την επεξεργαστεί.',
    ...
    'room' => [
        'destroy' => [
            'not_owner' => 'Μόνο ο ιδιοκτήτης δωματίου μπορεί να το κλείσει.',
        ],
    ],

    'score' => [
        'pin' => [
            'disabled_type' => "Αδυναμία καρφιτσώματος αυτού του τύπου βαθμολογίας",
            'failed' => "Αδυναμία καρφιτσώματος βαθμολογία μη επιτυχίας",
            'not_owner' => 'Μόνο ο ιδιοκτήτης της βαθμολογίας μπορεί να καρφιτσώσει βαθμολογία.',
            'too_many' => 'Καρφιτσωμένο πάρα πολλές βαθμολογίες.',
        ],
    ],
    ...
    'team' => [
        'application' => [
            'store' => [
                'already_member' => "Είσαι ήδη μέλος της ομάδας.",
                'already_other_member' => "Είσαι ήδη μέλος μιας διαφορετικής ομάδας",
                'currently_applying' => 'Έχεις ένα εκκρεμές αίτημα συμμετοχής για ομάδα.',
                'team_closed' => 'Αυτή τη στιγμή η ομάδα δεν δέχεται καμία αίτηση συμμετοχής.',
                'team_full' => "Η ομάδα είναι γεμάτη και δεν μπορεί να δεχτεί άλλα μέλη.",
            ],
        ],
        'part' => [
            'is_leader' => "Ο αρχηγός της ομάδας δεν μπορεί να φύγει από την ομάδα.",
            'not_member' => 'Δεν είναι μέλος της ομάδας.',
        ],
        'store' => [
            'require_supporter_tag' => 'osu!supporter tag απαιτείται για τη δημιουργία ομάδας.',
        ],
    ],
    ...
    'user' => [
        ...
        'update_email' => [
            'locked' => 'η διεύθυνση email είναι κλειδωμένη',
        ],
    ],
];
