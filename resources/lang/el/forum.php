...
return [
    ...
    'slogan' => "είναι επικίνδυνο να παίζεις μόνος σου.",
    ...
    'topic_watches' => [
        'index' => [
            ...
            'title_main' => '<strong>Εγγραφές</strong> Forum',
            ...
            'info' => [
                ...
                'unread' => 'Έχετε :undread μη αναγνωσμένες απαντήσεις σε θέματα που έχετε εγγραφεί.',
            ],
        ],
    ...
    'topics' => [
        ...
        'create' => [
            ...
            'poll' => [
                ...
                'length_info' => 'Αφήστε λευκό για μία ατελείωτη ψηφοφορία',
                ...
                'options' => 'Επιλογές',
                'options_info' => 'Τοποθέτησε κάθε επιλογή σε καινούργια γραμμή. Μπορείς να εισάγεις μέχρι 10 επιλογές.',
                'title' => 'Ερώτηση',
                'vote_change' => 'Επιτρέπεται η εκ νέου ψήφος.',
