...
return [
    ...
    'order' => [
        ...
        'not_modifiable_exception' => [
            ...
            'checkout' => 'Δεν μπορείτε να τροποποιήσετε την παραγγελία σας όσο βρίσκεται ύπο κατεργασία.', // checkout and processing should have the same message.
            ...
            'processing' => 'Δεν μπορείτε να τροποποιήσετε την παραγγελία σας όσο βρίσκεται ύπο κατεργασία.',
