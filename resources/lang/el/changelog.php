...
return [
    ...
    'support' => [
        'heading' => 'Σας αρέσει αυτή η ενημέρωση;',
        'text_1' => ':link σήμερα και υποστηρίξτε την περαιτέρω ανάπτυξη του osu!',
        'text_1_link' => 'Γίνετε supporter',
        'text_2' => 'Όχι μόνο θα βοηθήσετε στην ταχύτητα ανάπτυξης, αλλά θα λάβετε και κάποιες έξτρα λειτουργίες και προσαρμογές!',
    ],
];
