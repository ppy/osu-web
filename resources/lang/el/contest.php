...
return [
    'header' => [
        'small' => 'Ανταγωνιστείτε με περισσότερους τρόπου από το να πατάτε απλά κύκλους.',
        'large' => 'osu! Διαγωνισμοί Κοινότητας',
    ],
    'voting' => [
    ...
    'entry' => [
        ...
        'silenced_or_restricted' => 'Δεν μπορείτε να μπείτε σε διαγωνισμούς ενώ είστε περιορισμένοι (restricted) ή αποσιωπημένοι (silenced).',
