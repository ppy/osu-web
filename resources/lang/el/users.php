...
return [
    ...
    'login' => [
        ...
        'register' => "Δεν εχέτε λογαριασμό στο osu! ? Φτιάξτε ένα νέο",
        'forgot' => 'Ξεχάσατε τον κωδικό σας;',
        'beta' => [
            'main' => 'Η πρόσβαση στην έκδοση Beta ειναι περιορισμένη σε προνομιούχους χρήστες.',
            'small' => '(οι supporters θα εχούνε πρόσβαση σύντομα)',
        ],
    ...
    'logout_confirm' => 'Είστε σίγουρος ότι θέλετε να αποσυνδεθείτε; :(',
    'restricted_banner' => [
        'title' => 'Ο λογαριασμός σας έχει περιοριστεί!',
        'message' => 'Όσο βρίσκεσται υπό περιορισμό, δεν θα είστε σε θέση να αλληλεπιδράσετε με άλλους χρήστες και τα score σας θα είναι ορατά μόνο σε εσάς. Αυτό ειναι αποτέλεσμα μιας αυτόματης διαδικασίας που συνήθως διαρκεί 24 ώρες. Εάν επιθυμείτε την αναίρεση του περιορισμού, παρακαλώ <a href="mailto:accounts@ppy.sh">επικοινωνήστε με την ομάδα υποστήριξης</a>.',
    ],
    'show' => [
        'age' => ':age ετών',
        ...
        'extra' => [
            ...
            'kudosu' => [
                ...
                'total_info' => 'Βασισμένο στο πόσο έχει συνεισφέρει ο χρήστης για τον έλεγχο των beatmap. Δείτε <a href="'.osu_url('user.kudosu').'«>αυτή την σελίδα</a> για περισσότερες πληροφορίες.',
                ...
                'entry' => [
                    ...
                    'beatmap_discussion' => [
                        ...
                        'deny_kudosu' => [
                            'reset' => 'Αρνήθηκε :amount από την ανάρτηση modding :post',
                        ],
                        ...
                        'recalculate' => [
                            ...
                            'reset' => 'Χάσατε :amount από επαλυπολογισμό ψήφων για την επεξεργασία του post :post',
                        ],
                    ],
        ...
        'not_found' => [
            'reason_1' => 'Μπορεί να έχουν αλλάξει όνομα χρήστη.',
            'reason_2' => 'Ο λογαριασμός μπορεί να είναι προσωρινά μη διαθέσιμος λόγο προβλημάτων ασφάλειας η κατάχρησης.',
            'reason_3' => 'Μπορεί να έχετε κάνει τυπογραφικό λάθος!',
            'reason_header' => 'Υπάρχουν μερικοί εφικτοί λόγοι για αυτό:',
