...
return [
    'box' => [
        ...
        'info' => [
            ...
            'recover' => "Αν δεν έχετε πρόσβαση στο email σας ή έχετε ξεχάσει ποιο χρησιμοποιήσατε, παρακαλώ ακολουθήστε το :link.",
    ...
    'errors' => [
        ...
        'unknown' => 'Παρουσιάστηκε άγνωστο πρόβλημα, ένα νέο email επαλήθευσης έχει σταλεί.',
    ],
];
