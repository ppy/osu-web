...
return [
    'beatmapset_update_notice' => [
        ...
        'subject' => 'มีอัพเดตใหม่สำหรับบีทแมพ ":title"',
    ...
    'common' => [
        ...
        'ignore' => 'ถ้าคุณไม่ได้ส่งคำขอนี้ คุณสามารถเพิกเฉยต่ออีเมลฉบับนี้ได้อย่างปลอดภัย',
    ],
    ...
    'donation_thanks' => [
        ...
        'translation' => 'การแปลโดยชุมชนเพื่อวัตถุประสงค์ในการให้ข้อมูลดังต่อไปนี้:',

        'benefit' => [
            'gift' => 'ผู้รับของขวัญของคุณจะสามารถเข้าถึง osu!direct และสิทธิประโยชน์อื่นๆ อีกมากมายจากผู้สนับสนุน',
            'self' => 'ตอนนี้คุณสามารถเข้าถึง osu!direct และสิทธิประโยชน์อื่น ๆ อีกมากมายสำหรับผู้สนับสนุนเป็นเวลา :duration',
        ],

        'support' => [
            '_' => '
ขอบคุณมากๆ สำหรับ:supportของคุณต่อ osu!.',
            'first' => 'การสนับสนุน',
    ...
    'forum_new_reply' => [
        'new' => 'ขอแจ้งให้คุณทราบว่ามีการตอบกลับใหม่ใน ":title" ตั้งแต่การเข้าชมครั้งล่าสุดของคุณ',
...
หากคุณมีคำถามใด ๆ อย่าลังเลที่จะตอบกลับอีเมลนี้",
    ...
    'supporter_gift' => [
        'anonymous_gift' => 'คนที่ส่งแท็กผู้สนับสนุนให้อาจจะไม่อยากเปิดเผยตัวตน จึงไม่มีชื่อคนส่งให้ในการแจ้งเตือนนี้',
        ...
        'gift_message' => 'คนที่มอบแท็กให้คุณเป็นของขวัญได้ทิ้งข้อความนี้ไว้:',
