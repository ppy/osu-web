    ...
    'support' => [
        ...
        'why-support' => [
            ...
            'tournaments' => [
                ...
                'description' => 'ช่วยเงินค่าดำเนินการ (และรางวัล) ทัวร์นาเมนต์ osu! เวิลด์คัพ',
        ...
        'perks' => [
            ...
            'early_access' => [
                'title' => 'ทดลองใช้เวอร์ชั่นใหม่ก่อนใคร',
            ...
            'customisation' => [
                ...
                'description' => "เด่นกว่าใคร ปรับแต่งโปรไฟล์ได้ตามใจชอบ",
            ],

            'beatmap_filters' => [
                'title' => 'ตัวกรองบีทแมพ',
                'description' => 'กรองบีทแมพที่เล่นแล้ว/ยังไม่เล่น และแรงค์ที่เคยได้',
            ],
            ...
            'change_username' => [
                ...
                'description' => 'เปลี่ยนชื่อผู้เล่นของคุณได้โดยไม่เสียเงินได้ครั้งนึง เมื่อซื้อแท็กสนับสนุนในครั้งแรก',
            ],
            ...
            'friend_filtering' => [
                ...
                'description' => 'มาแข่งกับเพื่อนว่าใครเก่งกว่ากัน!',
            ],

        ],
        'supporter_status' => [
            'contribution_with_duration' => 'ขอบคุณที่สนับสนุนเรื่อยมา! ตอนนี้คุณได้สนับสนุนไป :dollars แล้วได้แท็ก "Supporter" เป็นระยะเวลา :duration',
            ...
            'gifted' => [
                '_' => 'ดูจากการการสนับสนุนของคุณแล้ว คุณมอบแท็กมูลค่า :dollars ให้กับ :users เป็นเวลา :duration ช่างใจกว้างซะจริง!',
                'users' => 'ผู้ใช้อื่น :count_delimited คน|ผู้ใช้อื่น :count_delimited คน',
            ],
        ],
    ],
];
