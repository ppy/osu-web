...
return [
    'achievement' => '<strong><em>:user</em></strong> ได้ปลดล็อคเหรียญ "<strong>:achievement</strong>" !',
    'beatmap_playcount' => ':beatmap ได้ถูกเล่นไปแล้วทั้งหมด :count ครั้ง!',
    'beatmapset_approve' => ':beatmapset โดย <strong>:user</strong> ได้ทำการ :approval แล้ว!',
    'beatmapset_delete' => ':beatmapset ได้โดนลบไปแล้ว',
    ...
    'user_support_gift' => '<strong>:user</strong> ได้รับของขวัญจากเพื่อนให้กลายเป็น osu! supporter - ยินดีด้วย',
    'username_change' => '<strong>:previousUsername</strong> ได้เปลี่ยนชื่อของเขาเป็น <strong><em>:user</strong></em>!',
];
