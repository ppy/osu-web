...
return [
    ...
    'beatmap_discussion' => [
        ...
        'nominate' => [
            ...
            'owner' => "ไม่สามารถเสนอชื่อบีตแม็ปของตัวเองได้",
            'set_metadata' => 'คุณต้องตั้งค่าหมวดหมู่เพลงและภาษาก่อนเสนอชื่อบีตแม็ป',
        ],
        'resolve' => [
            'not_owner' => 'เฉพาะผู้เริ่มกระทู้ และเจ้าของบีตแม็ปสามารถทำเครื่องหมายว่าการสนทนาถูกแก้ไขแล้ว',
        ],
        ...
        'vote' => [
            ...
            'wrong_beatmapset_state' => 'สามารถโหวตในการสนทนาของบีตแม็ปที่อยู่ในสถานะอยู่ระหว่างดำเนินการเท่านั้น',
        ],
    ],
    ...
    'beatmapset' => [
        'discussion_locked' => 'บีตแม็ปนี้ถูกล็อคไว้สำหรับการสนทนา',

        'metadata' => [
            'nominated' => 'คุณไม่สามารถเปลี่ยน metadata ของบีตแม็ปที่ทำการเสนอชื่อเป็นที่เรียบร้อยแล้ว ติดต่อ BN หรือ NAT หากคุณคิดว่ามีข้อผิดพลาดประการใด',
        ],
    ],

    'chat' => [
        'annnonce_only' => 'ช่องนี้สำหรับการประกาศเท่านั้น',
