...
return [
    ...
    'beatmap_tag' => [
        'store' => [
            'no_score' => 'จำเป็นต้องมีคะแนนบนบีทแมพก่อนที่จะเพิ่มแทก',
        ],
    ],
    ...
    'contest' => [
        'judging_not_active' => 'การตัดสินคอนเทสต์นี้ไม่แอคทีฟ',
        'voting_over' => 'คุณไม่สามารถเปลี่ยนการโหวตหลังจากระยะเวลาลงคะแนนเสียงสำหรับการประกวดนี้ได้สิ้นสุดลง',

        'entry' => [
            'limit_reached' => 'คุณถึงขีดจำกัดของปริมาณงานที่ส่งเข้าคอนเทสต์แล้ว',
            'over' => 'ขอบคุณที่เข้าร่วมการประกวดในครั้งนี้! เราได้ปิดรับผลงานสำหรับคอนเทสต์ครั้งนี้แล้วและการโหวตจะเริ่มขึ้นเร็วๆนี้',
        ],
    ],
    ...
    'forum' => [
        ...
        'post' => [
            ...
            'edit' => [
                ...
                'no_forum_access' => 'ต้องการการอนุญาติในการเข้าถึงฟอรั่มนี้',
                'no_permission' => 'ไม่ได้รับอนุญาตให้แก้ไข',
                'not_owner' => 'เฉพาะคนโพสต์เท่านั้นที่สามารถแก้ไขโพสต์ได้',
    ...
    'team' => [
        'application' => [
            'store' => [
                ...
                'already_other_member' => "คุณเป็นส่วนหนึ่งของกลุ่มอื่นแล้ว",
                'currently_applying' => 'คุณมีคำขอเข้าทีมที่กำลังดำเนินการอยู่',
                'team_closed' => 'ทีมนี้ไม่รับคำขอเข้าทีม',
        ...
        'store' => [
            'require_supporter_tag' => 'คุณต้องเป็น osu!supporter เพื่อสร้างทีม',
        ],
    ],
