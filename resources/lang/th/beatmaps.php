...
return [
    ...
    'discussions' => [
        ...
        'message_hint' => [
            'in_general' => 'โพสต์นี้จะไปที่การสนทนาทั่วไป ถ้าอยากวิจารณ์บีตแม็ปนี้ เริ่มต้นข้อความของคุณด้วยช่วงเวลา (เช่น 00:12:345)',
        ...
        'status-messages' => [
            'approved' => 'บีตแม็ปนี้ถูกอนุมัติในวันที่ :date',
            'graveyard' => "บีตแม็ปนี้ไม่ถูกอัปเดตตั้งแต่ :date และน่าจะถูกละทิ้งโดยผู้ทำแมพไปแล้ว",
            'loved' => 'บีตแม็ปนี้ถูกเพิ่มไปยัง "ชื่นชอบ" แล้วเมื่อวันที่ :date!',
            'ranked' => 'บีตแม็ปนี้ถูกจัดอันดับแล้วในวันที่ :date',
            'wip' => 'บีตแม็ปนี้ถูกทำเครื่องหมายไว้ว่าอยู่ในระหว่างการทำ',
        ],
    ...
    'hype' => [
        ...
        'explanation' => 'Hype บีตแม็ปนี้เพื่อทำให้ง่ายขึ้นต่อการเสนอชื่อและจัดอันดับ',
        'explanation_guest' => 'ลงชื่อเข้าใช้และ Hype บีตแม็ปนี้เพื่อทำให้ง่ายขึ้นต่อการเสนอชื่อและจัดอันดับ',
    ...
    'nominations' => [
        'already_nominated' => 'คุณได้เสนอชื่อบีตแม็ปนี้แล้ว',
        'cannot_nominate' => 'คุณไม่สามารถเสนอชื่อโหมดเกมของบีตแม็ปนี้ได้',
        'delete' => 'ลบ',
        'delete_own_confirm' => 'คุณแน่ใจใช่ไหม? บีตแม็ปจะถูกลบและคุณจะถูกนำกลับไปยังหน้าโปรไฟล์ของคุณ',
        ...
        'love_confirm' => 'ชอบบีตแม็ปนี้หรือไม่?',
        'nominate' => 'เสนอชื่อ',
        'nominate_confirm' => 'เสนอชื่อบีตแม็ปนี้?',
