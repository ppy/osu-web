...
return [
    'availability' => [
        'disabled' => 'บีตแม็ปนี้ยังไม่สามารถดาวน์โหลดได้',
        'parts-removed' => 'บางส่วนของบีตแม็ปนี้ถูกลบตามคำขอของผู้แต่งหรือผู้ถือสิทธิ์บุคคลสาม',
    ...
    'show' => [
        ...
        'deleted_banner' => [
            'title' => 'บีตแม็ปนี้ถูกลบไปแล้ว',
            'message' => '(ผู้ดูแลเท่านั้นที่สามารถเห็นสิ่งนี้)',
        ],

        'details' => [
            'by_artist' => 'โดย :artist',
            'favourite' => 'ชื่นชอบบีตแม็ปนี้',
            'favourite_login' => 'ลงชื่อเข้าใช้เพื่อเพิ่มบีตแม็ปนี้เข้าในรายการโปรด',
            'logged-out' => 'คุณต้องเข้าสู่ระบบก่อนที่จะดาวน์โหลดบีตแม็ป',
            'mapped_by' => 'แมพโดย :mapper',
            'mapped_by_guest' => 'ระดับความยากโดย :mapper',
            'unfavourite' => 'นำบีตแม็ปนี้ออกจากรายการโปรด',
        ...
        'favourites' => [
            'limit_reached' => 'คุณมีบีตแม็ปในรายการโปรดมากเกินไป! กรุณาเอาออกบ้างแล้วลองอีกครั้ง',
        ],
        ...
        'hype' => [
            ...
            'disqualify' => [
                '_' => 'ถ้าคุณพบปัญหากับบีตแม็ปนี้ ให้คุณยกเลิกสถานะ "ผ่านการรับรอง" ของบีตแม็ปนี้ออก :link',
            ],

            'report' => [
                '_' => 'หากคุณพบปัญหาเกี่ยวกับบีตแม็ปนี้ โปรดรายงานที่ :link เพื่อแจ้งให้ทีมงานทราบ',
                'button' => 'รายงานปัญหา',
                'link' => 'ที่นี่',
            ],
        ],
        ...
        'info' => [
            ...
            'source' => 'แหล่งที่มา',
            'storyboard' => 'บีตแม็ปนี้มีเนื้อเรื่อง',
            'success-rate' => 'อัตราการผ่าน',
            'tags' => 'แท็ก',
            'video' => 'บีตแม็ปนี้มีวิดีโอ',
        ],

        'nsfw_warning' => [
            'details' => 'บีตแม็ปนี้มีเนื้อหาไม่เหมาะสม, รุนแรง, หรือรบกวนใจ คุณยังจะต้องการดูมันไหม',
            'title' => 'เนื้อหาไม่เหมาะสม',

            'buttons' => [
                'disable' => 'ปิดการแจ้งเตือน',
                'listing' => 'รายชื่อบีตแม็ป',
                'show' => 'แสดง',
            ],
        ],
        ...
        'scoreboard' => [
            ...
            'no_scores' => [
                ...
                'unranked' => 'บีตแม็ปที่ไม่ได้จัดอันดับ',
            ],
            'score' => [
                'first' => 'สูงสุด',
