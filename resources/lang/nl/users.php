...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "Uploaden alleen beschikbaar voor <a href='".product_url('supporter_tag')."' target='_blank'>osu!supporters</a>",
        ...
        'page' => [
            ...
            'restriction_info' => "Je moet een <a href='".product_url('supporter_tag')."' target='_blank'>osu!supporter</a> zijn om dit te gebruiken.",
        ],
        'rank' => [
