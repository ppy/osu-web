...
return [
    ...
    'community' => [
        'slack' => [
            'not-eligible' => 'Jouw account is niet in de positie voor een Slack uitnodiging.',
            'slack-error' => 'Er ging iets mis bij de Slack servers. Probeer het opnieuw over een paar minuten.',
        ],
    ],
    'logged_out' => 'Je bent uitgelogd. Log opnieuw in en probeer opnieuw.',
    'supporter_only' => 'Je moet een supporter zijn om dit te gebruiken.',
    'no_restricted_access' => 'Je mag dit niet doen terwijl je account dit restricted status heeft.',
