...
return [
    ...
    'show' => [
        ...
        'edit' => [
            'cover' => [
                ...
                'upload' => [
                    ...
                    'restriction_info' => "自定义皮肤只有 <a href='".product_url('supporter-tag')."' target='_blank'>osu!支持者</a> 可用",
        ...
        'page' => [
            ...
            'edit_big' => '编辑',
            'placeholder' => '在这里编辑',
            'restriction_info' => "需要成为 <a href='".product_url('supporter-tag')."' target='_blank'>osu!支持者</a> 以解锁该特性.",
        ],
        'rank' => [
