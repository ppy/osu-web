...
return [
    'achievement' => '<strong><em>:user</em></strong> låste op for "<strong>:achievement</strong>" medaljen!',
    'beatmap_playcount' => ':beatmap er blevet spillet :count gange!',
    'beatmapset_approve' => ':beatmapset af <strong>:user</strong> er blevet :approval!',
    'beatmapset_delete' => ':beatmapset er blevet slettet.',
    ...
    'user_support_first' => '<strong>:user</strong> er blevet osu! supporter - tak for din gavmildhed!',
    'user_support_gift' => '<strong>:user</strong> har modtaget en gave med et osu! supporter tag!',
    'username_change' => '<strong>:previousUsername</strong> har skiftet deres brugernavn til <strong><em>:user</strong></em>!',
];
