...
return [
    ...
    'nominations' => [
        'disqualifed-at' => 'Diskvalificeret :time_ago (:reason).',
        'disqualifed_no_reason' => 'ingen årsag specificeret',
        'disqualification-prompt' => 'Årsag for diskvalifikation?',
        'disqualify' => 'Diskvalificér',
        'incorrect-state' => 'Fejl under udførelse, try prøv at genindlæse siden.',
        'nominate' => 'Nominér',
        'nominated-by' => 'nomineret af :users',
        'nominate-confirm' => 'Nominér dette beatmap?',
        'qualified' => 'Forventet at blive ranked på :date, hvis ingen problemer bliver fundet.',
        'qualified-soon' => 'Forventet at blive ranked snart, hvis ingen problemer bliver fundet.',
        'reset-confirm' => 'Er du sikker? Ved at slå et problem op, nulstiller du nomineringer.',
        'required-text' => 'Nomineringer: :current/:required',
