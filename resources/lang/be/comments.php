...
return [
    ...
    'editor' => [
        'textarea_hint' => [
            '_' => 'Націсніце enter, каб :action. Выкарыстоўвайце shift+enter для новага радка.',
            'edit' => 'захаваць',
            'new' => 'размясціць',
            'reply' => 'адказаць',
        ],
    ...
    'ogp' => [
        'title' => 'каментар ад :user',
    ],

    'placeholder' => [
        'edit' => 'Рэдагаваць каментарый',
        'new' => 'Напісаць новы каментарый',
        'reply' => 'Напішыце адказ',
    ],
