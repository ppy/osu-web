...
return [
    ...
    'report' => [
        ...
        'dmca' => [
            'message_1' => [
                '_' => 'Калі ласка, паведамліце пра парушэнне аўтарскіх правоў праз заяву DMCA на адрас эл. пошты :mail як указана в :policy.',
                'policy' => 'палітыка аўтарскіх правоў osu!',
            ],
            'message_2' => 'Гэта тычыцца выпадкаў, дзе трэкі аўдыё, візуальны кантэнт або змест узроўня бітмапы выкарыстоўваецца без карэктнага дазволю.',
        ],

        'options' => [
            'cheating' => 'Несумленная гульня / Чыты',
            'copyright_infringement' => 'Парушэнне аўтарскіх правоў',
    ...
    'show' => [
        ...
        'extra' => [
            ...
            'historical' => [
                ...
                'score_replay_stats' => [
                    'title' => 'Найбольш прагляданыя рэплэі',
                ],
            ],
            'kudosu' => [
