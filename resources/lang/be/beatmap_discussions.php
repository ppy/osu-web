...
return [
    ...
    'index' => [
        ...
        'form' => [
            ...
            'show_review_embeds' => 'Паказаць рэцэнзіі публікацыі',
    ...
    'refresh' => [
        'checking' => 'Праверка абнаўленняў...',
        'has_updates' => 'З\'явіліся новыя адказы. Націсніце для абнаўлення.',
