...
return [
    ...
    'discussions' => [
        ...
        'beatmap_information' => 'Старонка карты',
        'delete' => 'выдаліць',
        ...
        'message_hint' => [
            'in_general' => 'Гэты допіс пойдзе ў агульную тэму абмеркавання пакета карт. Каб змяніць гэту карту, пачніце сваё паведамленне з адзнакі часу (напрыклад 00:12:345).',
        ...
        'message_type' => [
            ...
            'praise' => 'Пахвала',
            'problem' => 'Праблема',
            'problem_warning' => 'Паведаміць аб праблеме',
            'review' => 'Адказ',
    ...
    'nominations' => [
        'already_nominated' => 'Вы ўжо намінавалі гэту бітмапу.',
        'cannot_nominate' => 'Вы не можаце намінаваць гэту бітмапу для гэтага гульнявога рэжыму.',
        'delete' => 'Выдаліць',
        ...
        'reset_confirm' => [
            ...
            'problem_warning' => 'Вы ўпэўнены аб паведамленні праблемы на гэтай бітмапе? Гэта паведаміць бітмап намінатараў.',
        ],
    ],
