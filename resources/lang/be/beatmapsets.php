...
return [
    ...
    'download' => [
        ...
        'no_mirrors' => 'Няма даступных сервераў загрузкі.',
    ],
    ...
    'nominate' => [
        'bng_limited_too_many_rulesets' => 'Намінатары, размешчаныя на выпрабаванні, не могуць намінаваць некалькі рэжымаў гульні адначасова.',
        'full_nomination_required' => 'Вы павінны быць паўнапраўным намінатарам, каб унесці вырашальны голас па гэтым рэжыму гульні.',
        ...
        'invalid_limited_nomination' => 'Гэтая карта мае недапушчальныя намінацыі і не можа быць кваліфікаваная.',
        'invalid_ruleset' => 'Недапушчальныя рэжымы гульні для гэтай намінацыі.',
        'too_many' => 'Патрабаванне да намінацыі ужо выканана.',
        'too_many_non_main_ruleset' => 'Патрабаванне намінацыі асноўнага рэжыму гульні ўжо было выканана.',

        'dialog' => [
            'confirmation' => 'Вы сапраўды жадаеце намінаваць гэту бiтмапу?',
            'different_nominator_warning' => 'Паўторная кваліфікацыя гэтай карты парай намінатараў, якая адрозніваецца ад першапачатковай, скінуць яе пазіцыю ў чарзе атрымання рэйтынгу.',
            ...
            'current_main_ruleset' => 'Цяперашні асноўны рэжым гульні: :ruleset',
    ...
    'show' => [
        ...
        'info' => [
            ...
            'success_rate_plays' => '',
            'user_tags' => 'Карыстальніцкія тэгі',
        ...
        'scoreboard' => [
            ...
            'no_scores' => [
                ...
                'team' => 'Ніхто з вашай каманды яшчэ не паставіў рэкорд на гэтай карте!',
