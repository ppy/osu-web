...
return [
    'support' => [
        'header' => [
            ...
            'small_description' => '',
            'support_button' => 'Я хачу патрымаць osu!',
        ],

        'dev_quote' => 'osu! — цалкам бясплатная гульня, але яе падтрымка — зусім не бясплатная.
        Не кажучы пра кошт арэнды сервераў і выскую якасць паласы прапускання па ўсяму свету, час, затрачаны на сістэму і супольнасць,
        ...
        А, яшчэ не забываецеся на той факт, што ўсё гэта мы робім без рэкламы і прасоўвання бескарысных панэляў інструментаў і таму падобнага!
            ...
            Хацелася б асабліва падзякаваць усім, хто патрымлівае osu! па гэты дзень,
            а таксама ўсіх, хто будзе падтрымліваць гэтую цудоўную гульню і яе супольнасць у будучыні :).',
