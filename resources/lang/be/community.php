...
return [
    'support' => [
        ...
        'why-support' => [
            'title' => 'Чаму мне падтрымліваць osu!? Куда ідуць грошы?',

            'team' => [
                'title' => 'Падтрымаць каманду распрацоўкі',
        ...
        'perks' => [
            ...
            'more_favourites' => [
                'title' => 'Больш выбраных бітмап',
                'description' => 'Максімальная колькасць бітмап, якіх вы можаце дадаць у абранае павялічылася з :normally &rarr; :supporter',
            ],
            'more_friends' => [
                'title' => 'Больш сяброў',
