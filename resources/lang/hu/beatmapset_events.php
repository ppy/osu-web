...
return [
    'event' => [
        ...
        'discussion_post_delete' => 'Egy moderátor hozzászólást törölt a :discussion megbeszélésből.',
        ...
        'love' => 'Loved kategóriába sorolta: :user.',
        'nominate' => 'Nominálva :user által.',
        'nominate_modes' => 'Nominálta: :user (:modes).',
        'nomination_reset' => 'Új probléma :discussion (:text) miatt a nominálás alaphelyzetbe állt.',
        'nomination_reset_received' => ':source_user visszaállította :user nominálását (:text)',
        'nomination_reset_received_profile' => ':user visszaállította a nominálást (:text)',
        'offset_edit' => 'Online eltolás megváltoztatva erről ":old" erre ":new".',
        'qualify' => 'Ez a beatmap elérte az elegendő számú nominálást és kvalifikálva lett.',
        'rank' => 'Rangsorolt.',
        'remove_from_loved' => ':user eltávolította a Loved kategóriából. (:text)',
        'tags_edit' => 'Műfaj megváltoztatva erről ":old" erre ":new".',

        'nsfw_toggle' => [
            'to_0' => 'Felnőtt tartalom jelölés törlése',
    ...
    'type' => [
        ...
        'offset_edit' => 'Eltolás szerkesztése',
