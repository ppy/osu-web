...
return [
    'event' => [
        'approve' => 'Jóváhagyva.',
        'discussion_delete' => 'A moderátor kitörölte a következő megbeszélést :discussion.',
        'discussion_post_delete' => 'A moderátor posztot törölt a következő megbeszélésből :discussion.',
        'discussion_post_restore' => 'A moderátor posztot állított vissza a következő megbeszélésből :discussion.',
        'discussion_restore' => 'Moderátor visszaállította a következő megbeszélést :discussion.',
        'disqualify' => 'Diszkvalifikálta :user. Indok: discussion (:text).',
