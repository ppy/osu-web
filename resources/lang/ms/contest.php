...
return [
    ...
    'entry' => [
        ...
        'allowed_extensions' => ':types fail yang diterima',
        'max_size' => 'Saiz maksimum: :limit',
        'required_dimensions' => 'Dimensi perlu :widthx:height ',
        'download' => 'Muat turun .osz',
        'wrong_file_type' => 'Hanya fail :types diterima untuk pertandingan ini.',
