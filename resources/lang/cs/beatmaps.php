...
return [
    ...
    'discussions' => [
        ...
        'status-messages' => [
            'approved' => 'Tato mapa byla schválena :date!',
            'graveyard' => "Tato beatmapa nebyla aktualizována od :date a pravděpodobně ji tvůrce odbyl...",
            'loved' => 'Tato beatmapa byla přidána do oblíbených komunitou :date!',
            'ranked' => 'Tato beatmapa byla hodnocena :date!',
            'wip' => 'Tato beatmapa byla označena jako rozdělaná jejím autorem.',
        ],
    ...
    'nominations' => [
        ...
        'love' => 'Láska',
        'love_choose' => 'Zvol obtížnost pro zařazení k oblíbeným komunitou',
        ...
        'remove_from_loved' => 'Odebrat z oblíbených komunitou',
        'remove_from_loved_prompt' => 'Důvod pro odebrání z oblíbených komunitou:',
