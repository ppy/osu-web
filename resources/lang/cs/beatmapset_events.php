...
return [
    'event' => [
        ...
        'discussion_post_delete' => 'Moderátor smazal příspěvek z diskuze :discussion.',
        'discussion_post_restore' => 'Moderátor obnovil příspěvek z diskuze :discussion.',
        ...
        'issue_reopen' => 'Vyřešený problém :discussion od :discussion_user byl znovu otevřen uživatelem :user.',
        'issue_resolve' => 'Problém :discussion od :discussion_user byl označen jako vyřešen uživatelem :user.',
        'kudosu_allow' => 'Odmítnutí kudosu pro diskuzi :discussion odebráno.',
        'kudosu_deny' => 'Diskuzi :discussion bylo odepřeno kudosu.',
        'kudosu_gain' => 'Diskuze :discussion uživatele :user dosáhla dostatku hlasů pro kudosu.',
    ...
    'type' => [
        ...
        'discussion_lock' => 'Uzamčení diskuze',
        ...
        'discussion_unlock' => 'Odemčení diskuze',
