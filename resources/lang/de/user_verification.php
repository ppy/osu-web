...
return [
    'box' => [
        'sent' => 'Eine E-Mail mit einem Bestätigungscode wurde an :mail gesendet. Gib den Code bitte ein.',
    ...
    'email' => [
        'subject' => 'osu!-Accountbestätigung',
    ],

    'errors' => [
        'expired' => 'Der Bestätigungscode ist abgelaufen, eine neue E-Mail wurde gesendet.',
        'incorrect_key' => 'Inkorrekter Bestätigungscode.',
        'retries_exceeded' => 'Inkorrekter Bestätigungscode. Maximale Anzahl an Versuchen ausgeschöpft, eine neue E-Mail wurde gesendet.',
        'reissued' => 'Neuer Bestätigungscode angefordert, eine neue E-Mail wurde gesendet.',
