...
return [
    ...
    'entry' => [
        ...
        'allowed_extensions' => 'Dateien im Format :types werden akzeptiert',
        'max_size' => 'Maximale Größe: :limit',
        'required_dimensions' => 'Das Format muss :widthx:height sein',
        'download' => '.osz herunterladen',
        'wrong_file_type' => 'Nur :types-Dateien werden in diesem Wettbewerb akzeptiert.',
