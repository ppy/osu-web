...
return [
    ...
    'entry' => [
        ...
        'allowed_extensions' => ':types filer är accepterade',
        'max_size' => 'Max storlek: :limit',
        'required_dimensions' => 'Dimensioner måste vara :widthx:height',
        'download' => 'Ladda ner .osz',
        'wrong_file_type' => 'Endast :types filer accepteras för denna tävling.',
