...
return [
    'beatmapset_update_notice' => [
        ...
        'unwatch' => '如果您不想再關注這張圖譜的話，可以點擊 “取消關注” 連結在頁面的下方，或者在摸圖關注頁面中：',
        'visit' => '訪問這裡的討論頁面：',
    ],
    ...
    'donation_thanks' => [
        ...
        'feedback' => "如果您有任何問題或建議，請直接回覆這封郵件。我會盡快回覆的！",
        'keep_free' => '多虧了像您這樣的人，讓 osu! 能夠在沒有任何廣告或強制付費的情況下保持遊戲和社群的順利運行。',
        'keep_running' => '您的支持可讓 osu! 持續執行大概 :minutes！雖然看起來沒有太多，但有大家的支持會更長久 :)。',
        'subject' => '非常感謝，osu! 愛你哦~',
        'translation' => '以下為社群提供的翻譯，僅供參考:',

        'benefit' => [
            'gift' => '您的收禮者現在可以使用 osu!direct 和許多其他支持者獨享的福利。',
            'self' => '您可以在接下來的 :duration 內享受 osu!direct 和其他贊助者享有的特權。',
        ],
    ...
    'forum_new_reply' => [
        ...
        'unwatch' => '如果您不想再關注本話題，您可以點擊主題頁下面的¨取消關注該主題¨連結，或者從訂閱管理頁面中取消訂閱。',
        'visit' => '使用以下連結跳到最新回覆：',
    ],
    ...
    'supporter_gift' => [
        ...
        'duration' => '因為他們，您可以在接下來的 :duration 內享受 osu!direct 和其他贊助者享有的特權。',
    ...
    'user_force_reactivation' => [
        'main' => '由於近期您的帳號有可疑的行為或者使用了強度較弱的密碼，目前已被暫時停用。因此我們需要您設定一個新的密碼。請確保使用強度較強的密碼。',
