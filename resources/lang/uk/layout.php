...
return [
    ...
    'popup_user' => [
        'links' => [
            ...
            'logout' => 'Вийти',
            'profile' => 'Мій профіль',
            'scoring_mode_toggle' => 'Класична система очків',
            'scoring_mode_toggle_tooltip' => 'Підлаштувати значення балів так, що це відчувалось як класична необмежена система очок',
        ],
    ],
