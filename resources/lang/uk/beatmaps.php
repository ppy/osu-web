...
return [
    ...
    'discussions' => [
        ...
        'message_placeholder_locked' => 'Обговорення для цієї карти відключено.',
        ...
        'message_hint' => [
            'in_general' => 'Цей пост піде в загальне обговорення. Щоб почати модерувати цю карту, почніть своє повідомлення з зазначенням часу (наприклад 00:12:345).',
            'in_timeline' => 'Для зміни декількох часових позначок, опублікуйте їх декілька разів (одна публікація на позначку).',
        ],
        ...
        'review' => [
            ...
            'embed' => [
                ...
                'timestamp' => [
                    ...
                    'diff' => 'Якщо цей :type починається з часової відмітки, воно буде показано під Хронологіею.',
                ],
            ],
            'insert-block' => [
        ...
        'status-messages' => [
            ...
            'ranked' => 'Ця карта потрапила в рангові :date!',
