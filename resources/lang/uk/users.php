...
return [
    ...
    'restricted_banner' => [
        ...
        'message' => 'Під час блокування вашого облікового запису, ви не зможете взаємодіяти з іншими гравцями, і ваші результати будуть показуватись лише для вас. Зазвичай, цей процес відбувається автоматично і як правило, ці обмеження облікового запису знімаються протягом доби. :link',
