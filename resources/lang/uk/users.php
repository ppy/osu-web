...
return [
    ...
    'disabled' => [
        ...
        'reasons' => [
            'compromised' => 'Можливо, ваш акаунт був скомпрометований. Він може бути тимчасово відключений, поки особистість власника підтверджується.',
    ...
    'login' => [
        ...
        'password' => 'Пароль',
        'register' => "У вас все ще немає акаунта osu!? Створіть новий",
