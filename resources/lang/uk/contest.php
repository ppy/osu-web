...
return [
    ...
    'entry' => [
        ...
        'allowed_extensions' => 'Приймаються лише файли :types ',
        'max_size' => 'Максимальний розмір: :limit',
        'required_dimensions' => 'Розміри мають бути обов\'язково :widthx:height',
        'download' => 'Завантажити .osz',
        'wrong_file_type' => 'Для цього конкурсу приймаються лише файли :types.',
