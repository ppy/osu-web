...
return [
    ...
    'privacy' => [
        ...
        'hide_online_info' => 'це позначить вас в статусі "не в мережі" в osu!lazer ',
    ...
    'user_totp' => [
        ...
        'usage_note' => 'Використовуйте додаток для автентифікації замість електронної пошти для верифікації. Електронна пошта буде доступна як запасний варіант.',

        'button' => [
            'remove' => 'Видалити',
            'setup' => 'Додати програму авторизації',
        ],
        'status' => [
            'label' => 'статус',
