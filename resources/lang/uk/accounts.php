...
return [
    ...
    'notifications' => [
        ...
        'news_post' => 'отримувати сповіщення про новини',
        'title' => 'Сповіщення',
        ...
        'options' => [
            ...
            'channel_mention' => 'згадки у чатах',
    ...
    'privacy' => [
        ...
        'hide_online_info' => 'це позначить вас у статусі "не в мережі" в osu!lazer ',
    ...
    'user_totp' => [
        'title' => 'Програма аутентифікації',
        'usage_note' => 'Використовуйте програму аутентифікації замість електронної пошти для верифікації. Електронна пошта буде доступна як запасний варіант.',

        'button' => [
            'remove' => 'Видалити',
            'setup' => 'Додати програму аутентифікації',
        ],
        'status' => [
            'label' => 'статус',
