...
return [
    ...
    'notifications' => [
        ...
        'tooltips' => [
            'beatmap_owner_change' => 'коли вас призначають автором гостьової бітмапи',
            'beatmapset:modding' => 'коли в обговореннях бітмапи, яку відстежуєте, з\'являється оновлення, або коли з\'являється проблема чи пропозиція для вашої власної бітмапи',
            'channel_mention' => 'коли вас згадують у публічному каналі',
            'channel_message' => 'коли ви отримуєте нове приватне повідомлення',
            'channel_team' => 'коли у вашому командному чаті з\'являється нове повідомлення',
            'comment_new' => 'коли з\'являється новий коментар до будь-чого, що ви відстежуєте',
            'forum_topic_reply' => 'коли тема на форумі, яку ви відстежуєте, отримує нові відповіді',
            'mapping' => 'коли мапер, якого ви відстежуєте, публікує нову бітмапу',
            'news_post' => 'коли з\'являються свіжі новини',
        ],
    ],
    ...
    'user_totp' => [
        ...
        'usage_note' => 'Використовуйте додаток для аутентифікації замість електронної пошти для верифікації. Електронна пошта буде доступна як запасний варіант.',
