...
return [
    ...
    'notifications' => [
        'beatmapset_discussion_qualified_problem' => 'отримувати сповіщення про нові проблеми на кваліфікованих картах для наступних режимів',
        'beatmapset_disqualify' => 'отримувати сповіщення коли карти наступних режимів будуть дискваліфіковані',
