...
return [
    'edit' => [
        ...
        'avatar' => [
            'title' => 'Аватар',
            'rules' => 'Будь ласка, переконайтесь що Ваш аватар відповідає :link.<br/>Це означає що він має підходити <strong>відповідно, людям будь-якого віку</strong>. Тобто: не містити наготу, нецензурну лексику або відвертий й непристойний вміст.',
