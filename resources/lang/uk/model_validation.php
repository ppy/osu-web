...
return [
    ...
    'beatmapset_discussion' => [
        ...
        'hype' => [
            'discussion_locked' => "Ця мапа зараз заблокована для обговорення і не може бути хайпнута",
            'guest' => 'Ви повинні ввійти для використання хайпу.',
            'hyped' => 'Ви вже хайпили цю мапу.',
            'limit_exceeded' => 'Ви вже використали весь свій хайп.',
            'not_hypeable' => 'Ця мапа не може бути хайпнута',
            'owner' => 'Ви не можете хайпити свої мапи.',
        ],

        'timestamp' => [
            'exceeds_beatmapset_length' => 'Зазначена часова мітка виходить за рамки довжини мапи.',
    ...
    'comment' => [
        'deleted_parent' => 'Неможливо відповісти на видалений коментар.',
    ...
    'user' => [
        ...
        'change_username' => [
            'restricted' => 'Ви не можете змінити ім\'я, поки ваш акаунт обмежено.',
            'supporter_required' => [
