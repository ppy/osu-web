...
return [
    ...
    'entry' => [
        ...
        'allowed_extensions' => 'S\'accepten fitxers :types',
        'max_size' => 'Mida màxima :limit',
        'required_dimensions' => 'Les dimensions han de ser :widthx:height',
        'download' => 'Descarregar .osz',
        'wrong_file_type' => 'Per a aquest torneig, només s\'accepten fitxers :types.',
