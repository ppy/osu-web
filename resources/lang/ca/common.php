...
return [
    'confirmation' => 'Estàs segur?',
    'confirmation_unsaved' => 'Els canvis no guardats es perdran. Estàs segur?',
    'saved' => 'Guardat',
    ...
    'buttons' => [
        ...
        'watch' => [
            'to_0' => 'Deixar de veure',
            'to_1' => 'Veure',
        ],
    ],

    'count' => [
        'badges' => ':count_delimited insígnia|:count_delimited insígnies',
        'days' => ':count_delimited dia|:count_delimited dies',
        'hour_short_unit' => 'h|h',
        'hours' => ':count_delimited hora|:count_delimited hores',
        'item' => ':count_delimited unitat|:count_delimited unitats',
        ...
        'update' => ':count_delimited actualització|:count_delimited actualitzacions',
        'view' => ':count_delimited visita|:count_delimited visites',
        'years' => ':count_delimited any|:count_delimited anys',
    ],
    ...
    'dropzone' => [
        'target' => 'deixa anar aquí per pujar',
    ],
    ...
    'time' => [
        'days_ago' => 'fa :count_delimited dia|fa :count_delimited dies',
        'hours_ago' => 'fa :count_delimited hora|fa :count_delimited hores',
        'now' => 'ara',
