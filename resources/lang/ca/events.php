...
return [
    'achievement' => '<strong><em>:user</em></strong> ha desbloquejat la medalla "<strong>:achievement</strong>"!',
    'beatmap_playcount' => ':beatmap s\'ha jugat :count vegades!',
    ...
    'user_support_gift' => '<strong>:user</strong> ha rebut el regal de osu!supporter!',
