...
return [
    'event' => [
        ...
        'love' => 'Milované používateľom :user.',
        ...
        'rank' => 'Ranked.',
        'remove_from_loved' => 'Odstránené z Milovaných užívateľom :user. (:text)',
        'tags_edit' => 'Tagy zmenené z ":old" na ":new".',
    ...
    'type' => [
        ...
        'discussion_lock' => 'Zamknúť diskusiu',
        ...
        'discussion_unlock' => 'Odomknúť diskusiu',
        ...
        'rank' => 'Hodnotenie',
        'remove_from_loved' => 'Odstránenie z milovaných',
        'tags_edit' => 'Upraviť tagy',
    ],
];
