...
@section('content')
    ...
    <div class="osu-layout__row osu-layout__row--page-compact">
        ...
        <div class="wiki-page">
            <div class="hidden-xs wiki-page__toc js-wiki-toc-float-container js-sticky-header" data-sticky-header-target="wiki-toc">
                <div class="js-sync-height--target" data-sync-height-id="wiki-toc"></div>
                <div class="wiki-toc js-wiki-toc js-wiki-toc-float js-sync-height--reference" data-sync-height-target="wiki-toc">
