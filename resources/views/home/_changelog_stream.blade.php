...
--}}
<a
  class="changelog-stream {{ $featured ? 'changelog-stream--featured' : '' }} {{ $build->version === $stream->version ? 'changelog-stream--active' : '' }} changelog-stream--{{ str_slug($stream->updateStream->pretty_name) }}"
