...
<div class="osu-layout__row osu-layout__row--page-compact">
    <div class="osu-page-header osu-page-header--wiki">
        <h1 class="osu-page-header__title"><i>Getting Started</i></h1>
        <h2 class="osu-page-header__title osu-page-header__title--small"><i>Hit Objects</i></h2>
    </div>
</div>

<div class='osu-layout__row osu-layout__row--page wiki-page'>
...
<script>
    //Example code for the navigation bar, hiding with small widths, active buttons, etc.
	...
	function checkNavSize(){
		if($(window).width() >= 900){
			if($("#wikinav").is(":visible") == false){
				$("#wikinav").show();
			}
		}else{
			if($("#wikinav").is(":visible") == true){
				$("#wikinav").hide();
			}
		}
	}
