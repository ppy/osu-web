...
--}}
<a href="{{route('users.show', ['user' => $user->user_id])}}" class="usercard{{$mutual ? ' usercard--mutual' : ''}}" style="background-image: url({{$user->cover()}});">
    ...
    <div class="usercard__status usercard__status--{{$user->isOnline() ? 'online' : 'offline'}}">
