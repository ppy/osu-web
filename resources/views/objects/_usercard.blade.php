    ...
    <div class="{{ $blockClass }}">
        ...
        <div class="usercard__card">
            ...
            <div class="usercard__status-bar usercard__status-bar--{{!isset($loading) && $user->isOnline() ? 'online' : 'offline'}}">
                ...
                <span class="usercard__status-message" title="{{isset($loading) || $user->isOnline() || $user->hide_presence ? '' : trans('users.show.lastvisit', ['date' => $user->user_lastvisit->diffForHumans()])}}">
