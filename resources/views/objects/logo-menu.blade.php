...
<div class="logo-menu">
    ...
    <div class="logo-menu__menu logo-menu__menu--main js-menu" data-menu-id="logo-menu">
        ...
        @foreach (nav_links() as $section => $links)
            <div class="logo-menu__menu-item">
                ...
                <div class="logo-menu__menu logo-menu__menu--sub js-menu" data-menu-id="logo-menu--{{ $section }}">
