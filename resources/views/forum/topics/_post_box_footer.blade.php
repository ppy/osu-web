...
<div class="post-editor__actions">
    <button
        class="
            ...
            btn-osu-default
            post-editor__action
            post-editor__action--compact
        "
        type="button"
        title="{{ trans("forum.topic.post_edit.zoom.end") }}"
    >
    ...
    <div class="visible-xs">
        <button
            ...
            "
            type="button"
            title="{{ trans("forum.topic.post_edit.zoom.start") }}"
        >
