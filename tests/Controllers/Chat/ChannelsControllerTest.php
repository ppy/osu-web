...
class ChannelsControllerTest extends TestCase
{
    ...
    {
        $this->json('GET', route('api.chat.channels.show', ['channel_id' => $this->publicChannel->channel_id]))
            ->assertStatus(401);
    }
    ...
    {
        $this->actingAs($this->user, 'api')
            ->json('GET', route('api.chat.channels.show', ['channel_id' => $this->publicChannel->channel_id]))
            ->assertStatus(404);
    }
    ...
    {
        $this->json('GET', route('api.chat.channels.show', ['channel_id' => $this->privateChannel->channel_id]))
            ->assertStatus(401);
    }
    ...
    {
        $this->actingAs($this->user, 'api')
            ->json('GET', route('api.chat.channels.show', ['channel_id' => $this->privateChannel->channel_id]))
            ->assertStatus(404);
    }
    ...
    {
        $this->json('GET', route('api.chat.channels.show', ['channel_id' => $this->pmChannel->channel_id]))
            ->assertStatus(401);
    }
    ...
    {
        $this->actingAs($this->user, 'api')
            ->json('GET', route('api.chat.channels.show', ['channel_id' => $this->pmChannel->channel_id]))
            ->assertStatus(404);
    }
    ...
    public function testChannelShowPMWhenTargetRestricted() // fail
    {
        ...
        $this->actingAs($this->user, 'api')
            ->json('GET', route('api.chat.channels.show', ['channel_id' => $pmChannel->channel_id]))
            ->assertStatus(404);
    }
    ...
    public function testChannelSendWhenGuest() // fail
    {
        $this->json(
            'POST',
            route('api.chat.channels.send', ['channel_id' => $this->publicChannel->channel_id]),
    ...
    public function testChannelSendWhenModerated() // fail
    {
        ...
        $this->actingAs($this->user, 'api')
            ->json(
                'POST',
                route('api.chat.channels.send', ['channel_id' => $moderatedChannel->channel_id]),
                ['message' => self::$faker->sentence()]
            )
            ->assertStatus(403);
    }
    ...
    public function testChannelSendWhenBlocking() // fail
    {
        ...
        $this->actingAs($this->user, 'api')
            ->json(
                'POST',
                route('api.chat.channels.send', ['channel_id' => $pmChannel->channel_id]),
                ['message' => self::$faker->sentence()]
            )
            ->assertStatus(403);
    }
